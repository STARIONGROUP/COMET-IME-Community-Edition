// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OrdinalScaleDialogViewModelTestFixture.cs" company="Starion Group S.A.">
...
namespace BasicRdl.Tests.ViewModels
{
    ...
    using OrdinalScaleDialogViewModel = BasicRdl.ViewModels.OrdinalScaleDialogViewModel;

    [TestFixture]
    internal class OrdinalScaleDialogViewModelTestFixture
    {
        private OrdinalScaleDialogViewModel viewmodel;
        ...
        public void Setup()
        {
            ...
            this.ordinalScale = new OrdinalScale(Guid.NewGuid(), null, null) { Name = "ordinalScale", ShortName = "dqk" };
        ...
        {
            Assert.AreEqual(this.viewmodel.Name, this.ordinalScale.Name);
            Assert.AreEqual(this.viewmodel.ShortName, this.ordinalScale.ShortName);
            Assert.AreEqual(this.viewmodel.IsDeprecated, this.ordinalScale.IsDeprecated);
            Assert.AreEqual(this.viewmodel.MappingToReferenceScale, this.ordinalScale.MappingToReferenceScale);
            Assert.AreEqual(this.viewmodel.IsMaximumInclusive, this.ordinalScale.IsMaximumInclusive);
            Assert.AreEqual(this.viewmodel.IsMinimumInclusive, this.ordinalScale.IsMinimumInclusive);
            Assert.AreEqual(this.viewmodel.MaximumPermissibleValue, this.ordinalScale.MaximumPermissibleValue);
            Assert.AreEqual(this.viewmodel.MinimumPermissibleValue, this.ordinalScale.MinimumPermissibleValue);
            Assert.AreEqual(this.viewmodel.NegativeValueConnotation, this.ordinalScale.NegativeValueConnotation);
            Assert.AreEqual(this.viewmodel.PositiveValueConnotation, this.ordinalScale.PositiveValueConnotation);
