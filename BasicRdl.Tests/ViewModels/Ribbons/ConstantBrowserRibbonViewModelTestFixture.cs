// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ConstantBrowserRibbonViewModelTestFixture.cs" company="Starion Group S.A.">
...
namespace BasicRdl.Tests.ViewModels.Ribbons
{
    ...
    /// <summary>
    /// Suite of tests for the <see cref="ConstantBrowserRibbonViewModel"/> class
    /// </summary>
    [TestFixture]
    public class ConstantBrowserRibbonViewModelTestFixture
    {
        ...
        {
            Assert.DoesNotThrow(() => new ConstantBrowserRibbonViewModel(this.messageBus));
        }

        [Test]
        public void VerifyThatInstantiatePanelViewModelReturnsExpectedViewModel()
        {
            var viewmodel = ConstantBrowserRibbonViewModel.InstantiatePanelViewModel(
                this.session.Object,
            ...
            Assert.IsInstanceOf<ConstantsBrowserViewModel>(viewmodel);
        }
    }
}
