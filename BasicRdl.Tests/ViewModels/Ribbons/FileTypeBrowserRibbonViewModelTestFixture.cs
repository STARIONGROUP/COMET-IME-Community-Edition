// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FileTypeBrowserRibbonViewModelTestFixture.cs" company="Starion Group S.A.">
...
namespace BasicRdl.Tests.ViewModels.Ribbons
{
    ...
    /// <summary>
    /// Suite of tests for the <see cref="FileTypeBrowserRibbonViewModel"/> class
    /// </summary>
    [TestFixture]
    public class FileTypeBrowserRibbonViewModelTestFixture
    {
        ...
        {
            Assert.DoesNotThrow(() => new FileTypeBrowserRibbonViewModel(this.messageBus));
        }

        [Test]
        public void VerifyThatInstantiatePanelViewModelReturnsExpectedViewModel()
        {
            var viewmodel = FileTypeBrowserRibbonViewModel.InstantiatePanelViewModel(
                this.session.Object,
            ...
            Assert.IsInstanceOf<FileTypeBrowserViewModel>(viewmodel);
        }
    }
}
