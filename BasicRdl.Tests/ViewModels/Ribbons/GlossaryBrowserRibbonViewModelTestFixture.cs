// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GlossaryBrowserRibbonViewModelTestFixture.cs" company="Starion Group S.A.">
...
namespace BasicRdl.Tests.ViewModels.Ribbons
{
    ...
    public class GlossaryBrowserRibbonViewModelTestFixture
    {
        ...
        {
            Assert.DoesNotThrow(() => new GlossaryBrowserRibbonViewModel(this.messageBus));
        }
