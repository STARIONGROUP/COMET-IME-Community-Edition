// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MeasurementScalesRibbonViewModelTestFixture.cs" company="Starion Group S.A.">
...
namespace BasicRdl.Tests.ViewModels.Ribbons
{
    ...
    /// <summary>
    /// Suite of tests for the <see cref="MeasurementScalesRibbonViewModel"/> class
    /// </summary>
    [TestFixture]
    public class MeasurementScalesRibbonViewModelTestFixture
    {
        ...
        {
            Assert.DoesNotThrow(() => new MeasurementScalesRibbonViewModel(this.messageBus));
        }

        [Test]
        public void VerifyThatInstantiatePanelViewModelReturnsExpectedViewModel()
        {
            var viewmodel = MeasurementScalesRibbonViewModel.InstantiatePanelViewModel(
                this.session.Object,
