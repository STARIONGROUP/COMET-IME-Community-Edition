// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MeasurementUnitsRibbonViewModelTestFixture.cs" company="Starion Group S.A.">
...
namespace BasicRdl.Tests.ViewModels.Ribbons
{
    ...
    /// <summary>
    /// Suite of tests for the <see cref="MeasurementUnitsRibbonViewModel"/> class
    /// </summary>
    [TestFixture]
    public class MeasurementUnitsRibbonViewModelTestFixture
    {
        ...
        {
            Assert.DoesNotThrow(() => new MeasurementUnitsRibbonViewModel(this.messageBus));
        }
