// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterTypeRibbonViewModelTestFixture.cs" company="Starion Group S.A.">
...
namespace BasicRdl.Tests.ViewModels.Ribbons
{
    ...
    public class ParameterTypeRibbonViewModelTestFixture
    {
        ...
        {
            Assert.DoesNotThrow(() => new ParameterTypeRibbonViewModel(this.messageBus));
        }
