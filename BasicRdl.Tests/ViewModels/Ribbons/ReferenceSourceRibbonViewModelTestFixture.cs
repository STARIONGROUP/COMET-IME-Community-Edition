// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ReferenceSourceRibbonViewModelTestFixture.cs" company="Starion Group S.A.">
...
namespace BasicRdl.Tests.ViewModels.Ribbons
{
    ...
    /// <summary>
    /// Suite of tests for the <see cref="ReferenceSourceRibbonViewModel"/> class
    /// </summary>
    [TestFixture]
    public class ReferenceSourceRibbonViewModelTestFixture
    {
        ...
        {
            Assert.DoesNotThrow(() => new ReferenceSourceRibbonViewModel(this.messageBus));
        }

        [Test]
        public void VerifyThatInstantiatePanelViewModelReturnsExpectedViewModel()
        {
            var viewmodel = ReferenceSourceRibbonViewModel.InstantiatePanelViewModel(
                this.session.Object,
            ...
            Assert.IsInstanceOf<ReferenceSourceBrowserViewModel>(viewmodel);
        }
    }
}
