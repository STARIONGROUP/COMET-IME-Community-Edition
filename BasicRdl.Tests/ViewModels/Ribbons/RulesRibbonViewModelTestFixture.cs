// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RulesRibbonViewModelTestFixture.cs" company="Starion Group S.A.">
...
namespace BasicRdl.Tests.ViewModels.Ribbons
{
    ...
    /// <summary>
    /// Suite of tests for the <see cref="RulesRibbonViewModel"/> class
    /// </summary>
    [TestFixture]
    public class RulesRibbonViewModelTestFixture
    {
        ...
        {
            Assert.DoesNotThrow(() => new RulesRibbonViewModel(this.messageBus));
        }

        [Test]
        public void VerifyThatInstantiatePanelViewModelReturnsExpectedViewModel()
        {
            var viewmodel = RulesRibbonViewModel.InstantiatePanelViewModel(
                this.session.Object,
            ...
            Assert.IsInstanceOf<RulesBrowserViewModel>(viewmodel);
        }
    }
}
