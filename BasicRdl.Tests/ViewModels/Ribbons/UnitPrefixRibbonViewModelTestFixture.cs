// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UnitPrefixRibbonViewModelTestFixture.cs" company="Starion Group S.A.">
...
namespace BasicRdl.Tests.ViewModels.Ribbons
{
    ...
    /// <summary>
    /// Suite of tests for the <see cref="UnitPrefixRibbonViewModel"/> class
    /// </summary>
    [TestFixture]
    public class UnitPrefixRibbonViewModelTestFixture
    {
        ...
        {
            Assert.DoesNotThrow(() => new UnitPrefixRibbonViewModel(this.messageBus));
        }

        [Test]
        public void VerifyThatInstantiatePanelViewModelReturnsExpectedViewModel()
        {
            var viewmodel = UnitPrefixRibbonViewModel.InstantiatePanelViewModel(
                this.session.Object,
            ...
            Assert.IsInstanceOf<UnitPrefixBrowserViewModel>(viewmodel);
        }
    }
}
