...
namespace BasicRDL.Tests
{
    ...
    /// <summary>
    /// Suite of tests for the <see cref="UnitPrefixRibbonViewModel"/>.
    /// </summary>
    [TestFixture]
    public class UnitPrefixRibbonViewModelTestFixture
    {
        ...
        {
            var viewmodel = new UnitPrefixRibbonViewModel(this.messageBus);
        ...
        {
            var vm = new UnitPrefixRibbonViewModel(this.messageBus);
