// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ClosingSiteRdlSessionRowViewModel.cs" company="Starion Group S.A.">
...
namespace BasicRdl.ViewModels
{
    ...
    /// <summary>
    /// The purpose of the <see cref="ClosingSiteRdlSessionRowViewModel"/> is to represent a <see cref="Session"/> 
    /// and its <see cref="SiteDirectory"/> 
    /// </summary>
    public class ClosingSiteRdlSessionRowViewModel : RowViewModelBase<Thing>
    {
        /// <summary>
        ...
        /// </param>
        public ClosingSiteRdlSessionRowViewModel(SiteDirectory siteDirectory, ISession session, IViewModelBase<Thing> containerViewModel)
            : base(siteDirectory, session, containerViewModel)
        {
            this.Name = siteDirectory.Name;
            this.ShortName = siteDirectory.ShortName;

            foreach (var siteRdl in this.Session.OpenReferenceDataLibraries.OfType<SiteReferenceDataLibrary>().OrderBy(rdl => rdl.GetRequiredRdls().Count()))
            {
