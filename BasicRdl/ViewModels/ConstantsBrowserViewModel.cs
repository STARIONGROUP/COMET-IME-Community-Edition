...
namespace BasicRdl.ViewModels
{
    ...
    /// </summary>
    public class ConstantsBrowserViewModel : BrowserViewModelBase<SiteDirectory>, IPanelViewModel
    {
        #region Fields
        ...
        public ConstantsBrowserViewModel(ISession session, SiteDirectory siteDir, IThingDialogNavigationService thingDialogNavigationService, IPanelNavigationService panelNavigationService, IDialogNavigationService dialogNavigationService)
