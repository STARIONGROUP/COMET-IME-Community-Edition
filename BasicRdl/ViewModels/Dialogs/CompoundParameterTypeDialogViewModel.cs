...
namespace BasicRdl.ViewModels
{
    ...
    public class CompoundParameterTypeDialogViewModel : CDP4CommonView.CompoundParameterTypeDialogViewModel, IThingDialogViewModel
    {
        ...
        protected override void InitializeCommands()
        {
            ...
            this.CreateComponentCommand = ReactiveCommand.Create(this.WhenAnyValue(x => x.IsReadOnly).Select(x => !x));
            this.CreateComponentCommand.Subscribe(_ => this.ExecuteCreateComponent());

            this.DeleteComponentCommand = ReactiveCommand.Create(this.WhenAnyValue(x => x.IsReadOnly).Select(x => !x));
