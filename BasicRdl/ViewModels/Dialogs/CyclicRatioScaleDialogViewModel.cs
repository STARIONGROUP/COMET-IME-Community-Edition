// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CyclicRatioScaleDialogViewModel.cs" company="RHEA System S.A.">
...
namespace BasicRdl.ViewModels
{
    ...
    /// <summary>
    /// The purpose of the <see cref="CyclicRatioScaleDialogViewModel"/> is to provide a dialog view model
    /// for a <see cref="CyclicRatioScale"/>
    /// </summary>
    [ThingDialogViewModelExport(ClassKind.CyclicRatioScale)]
    public class CyclicRatioScaleDialogViewModel : CDP4CommonView.CyclicRatioScaleDialogViewModel, IThingDialogViewModel
    {
        /// <summary>
