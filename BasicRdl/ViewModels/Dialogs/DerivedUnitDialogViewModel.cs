...
namespace BasicRdl.ViewModels
{
    ...
    public class DerivedUnitDialogViewModel : CDP4CommonView.DerivedUnitDialogViewModel, IThingDialogViewModel
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="DerivedUnit"/> is a base unit of the container <see cref="ReferenceDataLibrary"/>.
        /// </summary>
        ...
        {
            var orderedItems = this.Thing.UnitFactor.SortedItems.Values.ToList();

            base.UpdateTransaction();

            this.RestoreSortKeysOfDeletedItems(this.Thing.UnitFactor, orderedItems);
