// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OrdinalScaleDialogViewModel.cs" company="Starion Group S.A.">
...
namespace BasicRdl.ViewModels
{
    ...
    /// <summary>
    /// The purpose of the <see cref="OrdinalScaleDialogViewModel"/> is to provide a dialog view model
    /// for a <see cref="OrdinalScale"/>
    /// </summary>
    [ThingDialogViewModelExport(ClassKind.OrdinalScale)]
    public class OrdinalScaleDialogViewModel : CDP4CommonView.OrdinalScaleDialogViewModel, IThingDialogViewModel
    {
        /// <summary>
        ...
        /// </remarks>
        public OrdinalScaleDialogViewModel()
        {
        }
        ...
        /// </param>
        /// <param name="isRoot">
        /// Assert if this <see cref="OrdinalScaleDialogViewModel"/> is the root of all <see cref="IThingDialogViewModel"/>
        /// </param>
        /// <param name="dialogKind">
        /// The kind of operation this <see cref="OrdinalScaleDialogViewModel"/> performs
        /// </param>
        ...
        /// </exception>
        public OrdinalScaleDialogViewModel(OrdinalScale ordinalScale, IThingTransaction transaction, ISession session, bool isRoot, ThingDialogKind dialogKind, IThingDialogNavigationService thingDialogNavigationService, Thing container = null, IEnumerable<Thing> chainOfContainers = null)
            : base(ordinalScale, transaction, session, isRoot, dialogKind, thingDialogNavigationService, container, chainOfContainers)
        {
