...
namespace BasicRdl.ViewModels
{
    ...
    public class GlossaryBrowserViewModel : BrowserViewModelBase<SiteDirectory>, IPanelViewModel, IDropTarget
    {
        ...
        public GlossaryBrowserViewModel(ISession session, SiteDirectory siteDir, IThingDialogNavigationService thingDialogNavigationService, IPanelNavigationService panelNavigationService, IDialogNavigationService dialogNavigationService)
        ...
        {
            get { return this.canCreateGlossary; }
