...
namespace BasicRdl.ViewModels
{
    ...
    /// </summary>
    public class MeasurementScaleRowViewModel : MeasurementScaleRowViewModel<MeasurementScale>
    {
        /// <summary>
        ...
        private void CreateMeasurementUnitUpdateSubscription()
        {
            ...
            this.measurementUnitSubscription = this.CDPMessageBus.Listen<ObjectChangedEvent>(this.measurementUnitObject)
