...
namespace BasicRdl.ViewModels
{
    ...
    /// </summary>
    public class ParameterTypeRowViewModel : ParameterTypeRowViewModel<ParameterType>, IDropTarget
    {
        /// <summary>
        ...
        private void CreateDefaultScaleUpdateSubscription()
        {
            ...
            this.defaultScaleSubscription = this.CDPMessageBus.Listen<ObjectChangedEvent>(this.defaultScaleObject)
