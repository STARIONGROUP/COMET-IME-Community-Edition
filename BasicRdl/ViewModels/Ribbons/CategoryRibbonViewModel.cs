// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CategoryRibbonViewModel.cs" company="Starion Group S.A.">
...
namespace BasicRdl.ViewModels
{
    ...
    /// <summary>
    /// The view-model for the <see cref="BasicRdl.Views.CategoryRibbon"/> view
    /// </summary>
    public class CategoryRibbonViewModel : RibbonButtonSessionDependentViewModel
    {
        ...
        /// </param>
        public CategoryRibbonViewModel(ICDPMessageBus messageBus)
