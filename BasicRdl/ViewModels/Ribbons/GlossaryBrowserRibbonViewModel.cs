// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GlossaryBrowserRibbonViewModel.cs" company="Starion Group S.A.">
...
namespace BasicRdl.ViewModels
{
    ...
    public class GlossaryBrowserRibbonViewModel : RibbonButtonSessionDependentViewModel
    {
        ...
        /// </param>
        public GlossaryBrowserRibbonViewModel(ICDPMessageBus messageBus)
        ...
        public static IPanelViewModel InstantiatePanelViewModel(ISession session, IThingDialogNavigationService thingDialogNavigationService, IPanelNavigationService panelNavigationService, IDialogNavigationService dialogNavigationService, IPluginSettingsService pluginSettingsService)
        {
            ...
            stopWatch.Stop();
            Logger.Info("The Glossary Browser opened in {0}", stopWatch.Elapsed.ToString("hh':'mm':'ss'.'fff"));
            return viewModel;
        }
    }
}