...
namespace BasicRdl.ViewModels
{
    ...
    public class MeasurementScalesRibbonViewModel : RibbonButtonSessionDependentViewModel
    {
        ...
        public static IPanelViewModel InstantiatePanelViewModel(ISession session, IThingDialogNavigationService thingDialogNavigationService, IPanelNavigationService panelNavigationService, IDialogNavigationService dialogNavigationService)
        {
            ...
            var viewModel = new MeasurementScalesBrowserViewModel(session, session.RetrieveSiteDirectory(), thingDialogNavigationService, panelNavigationService, dialogNavigationService);
            stopWatch.Stop();
