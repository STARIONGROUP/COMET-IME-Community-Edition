// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ReferenceSourceRibbonViewModel.cs" company="Starion Group S.A.">
...
namespace BasicRdl.ViewModels
{
    ...
    /// <summary>
    /// The view-model for the <see cref="Views.ReferenceSourceRibbon"/> view
    /// </summary>
    public class ReferenceSourceRibbonViewModel : RibbonButtonSessionDependentViewModel
    {
        ...
        /// </param>
        public ReferenceSourceRibbonViewModel(ICDPMessageBus messageBus)
        ...
        public static IPanelViewModel InstantiatePanelViewModel(ISession session, IThingDialogNavigationService thingDialogNavigationService, IPanelNavigationService panelNavigationService, IDialogNavigationService dialogNavigationService, IPluginSettingsService pluginSettingsService)
        {
            ...
            var viewModel = new ReferenceSourceBrowserViewModel(session, session.RetrieveSiteDirectory(), thingDialogNavigationService, panelNavigationService, dialogNavigationService, pluginSettingsService);
            stopWatch.Stop();
            Logger.Info("The Reference Source Browser opened in {0", stopWatch.Elapsed.ToString("hh':'mm':'ss'.'fff"));
            return viewModel;
        }
    }
}
