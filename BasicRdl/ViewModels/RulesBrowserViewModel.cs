...
namespace BasicRdl.ViewModels
{
    ...
    public class RulesBrowserViewModel : BrowserViewModelBase<SiteDirectory>, IPanelViewModel
    {
        ...
        public RulesBrowserViewModel(ISession session, SiteDirectory siteDir, IThingDialogNavigationService thingDialogNavigationService, IPanelNavigationService panelNavigationService, IDialogNavigationService dialogNavigationService)
