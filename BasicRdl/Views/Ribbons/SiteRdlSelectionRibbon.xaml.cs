// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SiteRdlSelectionRibbon.xaml.cs" company="Starion Group S.A.">
...
namespace BasicRdl.Views
{
    ...
    public partial class SiteRdlSelectionRibbon : IView
    {
        ...
        public SiteRdlSelectionRibbon()
        {
            ...
            this.DataContext = new SiteRdlSelectionRibbonViewModel(dialogNavigationService, messageBus);
        }
    }
}
