// -------------------------------------------------------------------------------------------------
// <copyright file="SubSystemGenericBudgetResult.cs" company="RHEA System S.A.">
...
namespace CDP4Budget.Services
{
    ...
    /// </summary>
    public abstract class SubSystemGenericBudgetResult<T> : SubSystemBudgetResult<T>, ISubSystemGenericBudgetResult where T : BudgetParameterConfigBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubSystemGenericBudgetResult{T}"/> class
        /// </summary>
        ...
        protected SubSystemGenericBudgetResult(SubSystem subsystem, BudgetConfig config, Option option, DomainOfExpertise domain) : base(subsystem, config, option, domain)
        {
        }
