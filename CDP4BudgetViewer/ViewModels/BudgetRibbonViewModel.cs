// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BudgetRibbonViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4Budget.ViewModels
{
    ...
    public class BudgetRibbonViewModel : RibbonButtonIterationDependentViewModel
    {
        ...
        /// </param>
        public BudgetRibbonViewModel(ICDPMessageBus messageBus) : base(InstantiatePanelViewModel, messageBus)
        {
        }
