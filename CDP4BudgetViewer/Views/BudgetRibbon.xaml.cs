// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BudgetRibbon.xaml.cs" company="Starion Group S.A.">
...
namespace CDP4Budget.Views
{
    ...
    public partial class BudgetRibbon : ExtendedRibbonPageGroup, IView
    {
        ...
        public BudgetRibbon(ICDPMessageBus messageBus)
        {
            this.InitializeComponent();
            this.DataContext = new BudgetRibbonViewModel(messageBus);
        }
    }
}
