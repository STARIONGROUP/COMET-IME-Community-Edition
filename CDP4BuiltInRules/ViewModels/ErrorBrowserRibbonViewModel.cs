// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ErrorBrowserRibbonViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4BuiltInRules.ViewModels
{
    ...
    public class ErrorBrowserRibbonViewModel : RibbonButtonSessionDependentViewModel
    {
        ...
        /// </param>
        public ErrorBrowserRibbonViewModel(ICDPMessageBus messageBus)
        ...
        /// <summary>
        /// returns a new instance of the <see cref="ErrorBrowserViewModel"/> class
        /// </summary>
        ...
        /// <returns>An instance of the <see cref="ErrorBrowserViewModel"/> class</returns>
