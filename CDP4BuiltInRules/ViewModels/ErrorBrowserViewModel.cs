// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ErrorBrowserViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4BuiltInRules.ViewModels
{
    ...
    public class ErrorBrowserViewModel : BrowserViewModelBase<SiteDirectory>, IPanelViewModel
    {
        ...
        /// </summary>
        public ReactiveCommand<Unit, Unit> CopyErrorCommand { get; protected set; }
        ...
        protected override void InitializeCommands()
        {
            ...
            this.CopyErrorCommand = ReactiveCommandCreator.Create(this.ExecuteCopyErrorCommand, canSelectableCommandsExecute);
        }
