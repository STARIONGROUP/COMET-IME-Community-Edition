...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="DateParameterType"/>
    /// </summary>
    public partial class DateParameterTypeDialogViewModel : ScalarParameterTypeDialogViewModel<DateParameterType>
    {
        ...
        /// </param>
        public DateParameterTypeDialogViewModel(DateParameterType dateParameterType, IThingTransaction transaction, ISession session, bool isRoot, ThingDialogKind dialogKind, IThingDialogNavigationService thingDialogNavigationService, Thing container, IEnumerable<Thing> chainOfContainers) : base(dateParameterType, transaction, session, isRoot, dialogKind, thingDialogNavigationService, container, chainOfContainers)
        {
            if(container != null)
            {
        ...
        /// <summary>
        /// Populate the possible containers for a <see cref="DateParameterType"/>
        /// </summary>
