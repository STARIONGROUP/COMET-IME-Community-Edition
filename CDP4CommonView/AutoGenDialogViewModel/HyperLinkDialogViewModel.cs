// -------------------------------------------------------------------------------------------------
// <copyright file="HyperLinkDialogViewModel.cs" company="RHEA System S.A.">
...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="HyperLink"/>
    /// </summary>
    public partial class HyperLinkDialogViewModel : DialogViewModelBase<HyperLink>
    {
        /// <summary>
        ...
        /// </param>
        public HyperLinkDialogViewModel(HyperLink hyperLink, IThingTransaction transaction, ISession session, bool isRoot, ThingDialogKind dialogKind, IThingDialogNavigationService thingDialogNavigationService, Thing container, IEnumerable<Thing> chainOfContainers) : base(hyperLink, transaction, session, isRoot, dialogKind, thingDialogNavigationService, container, chainOfContainers)
        {
            if(container != null)
            {
