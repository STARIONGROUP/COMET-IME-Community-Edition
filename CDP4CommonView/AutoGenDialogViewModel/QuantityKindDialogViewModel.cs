// -------------------------------------------------------------------------------------------------
// <copyright file="QuantityKindDialogViewModel.cs" company="RHEA System S.A.">
...
namespace CDP4CommonView
{
    ...
    public abstract partial class QuantityKindDialogViewModel<T> : ScalarParameterTypeDialogViewModel<T> where T : QuantityKind
    {
        ...
        /// </summary>
        public ReactiveCommand<object> InspectSelectedDefaultScaleCommand { get; protected set; }
        ...
        protected override void InitializeCommands()
        {
            ...
            this.InspectSelectedDefaultScaleCommand = ReactiveCommand.Create(canExecuteInspectSelectedDefaultScaleCommand);
