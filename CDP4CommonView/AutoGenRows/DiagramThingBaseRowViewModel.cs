// -------------------------------------------------------------------------------------------------
// <copyright file="DiagramThingBaseRowViewModel.cs" company="RHEA S.A.">
...
namespace CDP4CommonView
{
    ...
    /// </summary>
    public abstract partial class DiagramThingBaseRowViewModel<T> : RowViewModelBase<T> where T : DiagramThingBase
    {
