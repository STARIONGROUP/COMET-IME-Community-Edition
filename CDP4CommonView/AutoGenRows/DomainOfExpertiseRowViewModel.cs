// -------------------------------------------------------------------------------------------------
// <copyright file="DomainOfExpertiseRowViewModel.cs" company="RHEA S.A.">
...
namespace CDP4CommonView
{
    ...
    /// </summary>
    public partial class DomainOfExpertiseRowViewModel : DefinedThingRowViewModel<DomainOfExpertise>
    {
        ...
        public DomainOfExpertiseRowViewModel(DomainOfExpertise domainOfExpertise, ISession session, IViewModelBase<Thing> containerViewModel) : base(domainOfExpertise, session, containerViewModel)
        {
