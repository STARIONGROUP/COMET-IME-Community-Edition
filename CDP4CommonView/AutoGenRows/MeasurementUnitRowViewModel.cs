// -------------------------------------------------------------------------------------------------
// <copyright file="MeasurementUnitRowViewModel.cs" company="RHEA S.A.">
...
namespace CDP4CommonView
{
    ...
    /// </summary>
    public abstract partial class MeasurementUnitRowViewModel<T> : DefinedThingRowViewModel<T> where T : MeasurementUnit
    {
