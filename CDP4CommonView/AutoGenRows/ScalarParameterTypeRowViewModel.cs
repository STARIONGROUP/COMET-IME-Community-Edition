// -------------------------------------------------------------------------------------------------
// <copyright file="ScalarParameterTypeRowViewModel.cs" company="RHEA S.A.">
...
namespace CDP4CommonView
{
    ...
    /// </summary>
    public abstract partial class ScalarParameterTypeRowViewModel<T> : ParameterTypeRowViewModel<T> where T : ScalarParameterType
    {
