// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PluginLoaderTestFixture.cs" company="Starion Group S.A.">
...
namespace CDP4Composition.Tests.Modularity
{
    ...
    public class PluginLoaderTestFixture
    {
        ...
        public void Setup()
        {
            ...
            this.appSettings = JsonConvert.DeserializeObject<TestAppSettings>(File.ReadAllText(Path.Combine(Assembly.GetExecutingAssembly().Location, @"../Modularity/", AppSettingsJson)));
        ...
        {
            var pluginLoader = new PluginLoader<TestAppSettings>();
