...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="Alias"/>
    /// </summary>
    public partial class AliasDialogViewModel : DialogViewModelBase<Alias>
    {
        /// <summary>
        /// Backing field for <see cref="IsSynonym"/>
        /// </summary>
        ...
        /// </param>
        public AliasDialogViewModel(Alias alias, IThingTransaction transaction, ISession session, bool isRoot, ThingDialogKind dialogKind, IThingDialogNavigationService thingDialogNavigationService, Thing container, IEnumerable<Thing> chainOfContainers) : base(alias, transaction, session, isRoot, dialogKind, thingDialogNavigationService, container, chainOfContainers)
        {
            if(container != null)
            {
        ...
        protected override void UpdateTransaction()
        {
            ...
            clone.IsSynonym = this.IsSynonym;
