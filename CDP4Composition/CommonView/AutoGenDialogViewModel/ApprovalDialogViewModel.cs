// -------------------------------------------------------------------------------------------------
// <copyright file="ApprovalDialogViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="Approval"/>
    /// </summary>
    public partial class ApprovalDialogViewModel : GenericAnnotationDialogViewModel<Approval>
    {
        /// <summary>
        ...
        /// </remarks>
        public ApprovalDialogViewModel()
        {
        }
        ...
        /// </summary>
        public virtual AnnotationApprovalKind Classification
        {
        ...
        protected override void InitializeCommands()
        {
            ...
            this.InspectSelectedAuthorCommand = ReactiveCommandCreator.Create(() => this.ExecuteInspectCommand(this.SelectedAuthor),
                canExecuteInspectSelectedAuthorCommand);
            
            var canExecuteInspectSelectedOwnerCommand = this.WhenAny(vm => vm.SelectedOwner, v => v.Value != null);
            this.InspectSelectedOwnerCommand = ReactiveCommandCreator.Create(() => this.ExecuteInspectCommand(this.SelectedOwner),
                canExecuteInspectSelectedOwnerCommand);
        }
