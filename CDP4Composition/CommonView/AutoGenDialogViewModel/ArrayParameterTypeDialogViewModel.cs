// -------------------------------------------------------------------------------------------------
// <copyright file="ArrayParameterTypeDialogViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="ArrayParameterType"/>
    /// </summary>
    public partial class ArrayParameterTypeDialogViewModel : CompoundParameterTypeDialogViewModel
    {
        /// <summary>
        ...
        /// </summary>
        public ReactiveList<PrimitiveRow<int>> dimension;
        ...
        public ReactiveList<PrimitiveRow<int>> Dimension
        {
            ...
            set { this.RaiseAndSetIfChanged(ref this.dimension, value); }
        }
        ...
        protected override void UpdateTransaction()
        {
            ...
            clone.Dimension.Clear();
            clone. Dimension.AddOrderedItems(this.Dimension.Select(x => new OrderedItem { K = x.Index, V = x.Value }));
        ...
        {
            base.Initialize();
            this.Dimension = new ReactiveList<PrimitiveRow<int>>();
            this.PopulatePossibleContainer();
        }

        /// <summary>
        /// Populate the possible containers for a <see cref="ArrayParameterType"/>
        /// </summary>
        ...
        /// <summary>
        /// Populates the <see cref="Dimension"/> property
        /// </summary>
        protected virtual void PopulateDimension()
        {
            this.Dimension.Clear();
            foreach(var value in ((ArrayParameterType)this.Thing).Dimension.SortedItems)
            {
                this.Dimension.Add(new PrimitiveRow<int> { Index = value.Key, Value = value.Value });
            }
        }
    }
}
