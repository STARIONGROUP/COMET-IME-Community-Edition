// -------------------------------------------------------------------------------------------------
// <copyright file="BooleanExpressionDialogViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="BooleanExpression"/>
    /// </summary>
    public abstract partial class BooleanExpressionDialogViewModel<T> : DialogViewModelBase<T> where T : BooleanExpression
    {
