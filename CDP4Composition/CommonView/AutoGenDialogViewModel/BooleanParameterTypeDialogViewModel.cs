// -------------------------------------------------------------------------------------------------
// <copyright file="BooleanParameterTypeDialogViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="BooleanParameterType"/>
    /// </summary>
    public partial class BooleanParameterTypeDialogViewModel : ScalarParameterTypeDialogViewModel<BooleanParameterType>
    {
        ...
        /// The <see cref="BooleanParameterType"/> that is the subject of the current view-model. This is the object
        ...
        /// </param>
        public BooleanParameterTypeDialogViewModel(BooleanParameterType booleanParameterType, IThingTransaction transaction, ISession session, bool isRoot, ThingDialogKind dialogKind, IThingDialogNavigationService thingDialogNavigationService, Thing container, IEnumerable<Thing> chainOfContainers) : base(booleanParameterType, transaction, session, isRoot, dialogKind, thingDialogNavigationService, container, chainOfContainers)
        {
            if(container != null)
            {
        ...
        /// <summary>
        /// Populate the possible containers for a <see cref="BooleanParameterType"/>
        /// </summary>
