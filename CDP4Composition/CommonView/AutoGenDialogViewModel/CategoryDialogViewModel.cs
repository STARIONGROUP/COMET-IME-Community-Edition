...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="Category"/>
    /// </summary>
    public partial class CategoryDialogViewModel : DefinedThingDialogViewModel<Category>
    {
        /// <summary>
        ...
        /// <summary>
        /// Backing field for PermissibleClass
        /// </summary>
        public ReactiveList<ClassKind> permissibleClass;
        ...
        public ReactiveList<ClassKind> PermissibleClass
        {
            get { return this.permissibleClass; }
            set { this.RaiseAndSetIfChanged(ref this.permissibleClass, value); }
        }
        
        /// <summary>
        /// Backing field for <see cref="SuperCategory"/>s
        /// </summary>
        private ReactiveList<Category> superCategory;

        /// <summary>
        /// Gets or sets the list of selected <see cref="Category"/>s
        /// </summary>
        public ReactiveList<Category> SuperCategory 
        { 
            get { return this.superCategory; } 
            set { this.RaiseAndSetIfChanged(ref this.superCategory, value); } 
        }

        /// <summary>
        /// Gets or sets the Possible <see cref="Category"/> for <see cref="SuperCategory"/>
        /// </summary>
        public ReactiveList<Category> PossibleSuperCategory { get; protected set; }
        ...
        protected override void UpdateTransaction()
        {
            ...
            clone.PermissibleClass.Clear();
            clone.PermissibleClass.AddRange(this.PermissibleClass);
 
            clone.SuperCategory.Clear();
            clone.SuperCategory.AddRange(this.SuperCategory);
        ...
        {
            base.Initialize();
            this.PermissibleClass = new ReactiveList<ClassKind>();
            this.SuperCategory = new ReactiveList<Category>();
            this.PossibleSuperCategory = new ReactiveList<Category>();
            this.PopulatePossibleContainer();
        }

        /// <summary>
        /// Populate the possible containers for a <see cref="Category"/>
        /// </summary>
        ...
        protected override void UpdateProperties()
        {
            ...
            this.PopulatePermissibleClass();
            this.PopulateSuperCategory();
        }

        /// <summary>
        /// Populates the <see cref="PermissibleClass"/> property
        /// </summary>
        protected virtual void PopulatePermissibleClass()
        {
            this.PermissibleClass.Clear();
            foreach(var value in this.Thing.PermissibleClass)
            {
                this.PermissibleClass.Add(value);
            }
        }

        /// <summary>
        /// Populates the <see cref="SuperCategory"/> property
        /// </summary>
        protected virtual void PopulateSuperCategory()
        {
            this.SuperCategory.Clear();

            foreach (var value in this.Thing.SuperCategory)
            {
                this.SuperCategory.Add(value);
            }
        } 
    }
}
