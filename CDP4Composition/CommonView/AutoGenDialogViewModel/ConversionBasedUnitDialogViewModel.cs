// -------------------------------------------------------------------------------------------------
// <copyright file="ConversionBasedUnitDialogViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// </summary>
    public abstract partial class ConversionBasedUnitDialogViewModel<T> : MeasurementUnitDialogViewModel<T> where T : ConversionBasedUnit
    {
        /// <summary>
        ...
        /// <summary>
        /// Backing field for <see cref="SelectedReferenceUnit"/>
        /// </summary>
        private MeasurementUnit selectedReferenceUnit;


        /// <summary>
        /// Initializes a new instance of the <see cref="ConversionBasedUnitDialogViewModel{T}"/> class.
        /// </summary>
        /// <remarks>
        /// The default constructor is required by MEF
        /// </remarks>
        protected ConversionBasedUnitDialogViewModel()
        {
        }
        ...
        /// The <see cref="ConversionBasedUnit"/> that is the subject of the current view-model. This is the object
        ...
        /// </param>
        protected ConversionBasedUnitDialogViewModel(T conversionBasedUnit, IThingTransaction transaction, ISession session, bool isRoot, ThingDialogKind dialogKind, IThingDialogNavigationService thingDialogNavigationService, Thing container, IEnumerable<Thing> chainOfContainers) : base(conversionBasedUnit, transaction, session, isRoot, dialogKind, thingDialogNavigationService, container, chainOfContainers)
        {
            if(container != null)
            {
        ...
        /// <summary>
        /// Gets or sets the SelectedReferenceUnit
        /// </summary>
        public virtual MeasurementUnit SelectedReferenceUnit
        {
            get { return this.selectedReferenceUnit; }
            set { this.RaiseAndSetIfChanged(ref this.selectedReferenceUnit, value); }
        }

        /// <summary>
        /// Gets or sets the possible <see cref="MeasurementUnit"/>s for <see cref="SelectedReferenceUnit"/>
        /// </summary>
        public ReactiveList<MeasurementUnit> PossibleReferenceUnit { get; protected set; }
        ...
        {
            base.Initialize();
            this.PossibleReferenceUnit = new ReactiveList<MeasurementUnit>();
            this.PopulatePossibleContainer();
        }

        /// <summary>
        /// Populate the possible containers for a <see cref="ConversionBasedUnit"/>
        /// </summary>
        ...
        protected override void UpdateProperties()
        {
            ...
            this.SelectedReferenceUnit = this.Thing.ReferenceUnit;
            this.PopulatePossibleReferenceUnit();
        }

        /// <summary>
        /// Populates the <see cref="PossibleReferenceUnit"/> property
        /// </summary>
        protected virtual void PopulatePossibleReferenceUnit()
        {
            this.PossibleReferenceUnit.Clear();
        }
    }
}
