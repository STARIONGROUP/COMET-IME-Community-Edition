...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="DateTimeParameterType"/>
    /// </summary>
    public partial class DateTimeParameterTypeDialogViewModel : ScalarParameterTypeDialogViewModel<DateTimeParameterType>
    {
        ...
        /// </param>
        public DateTimeParameterTypeDialogViewModel(DateTimeParameterType dateTimeParameterType, IThingTransaction transaction, ISession session, bool isRoot, ThingDialogKind dialogKind, IThingDialogNavigationService thingDialogNavigationService, Thing container, IEnumerable<Thing> chainOfContainers) : base(dateTimeParameterType, transaction, session, isRoot, dialogKind, thingDialogNavigationService, container, chainOfContainers)
        {
            if(container != null)
            {
        ...
        /// <summary>
        /// Populate the possible containers for a <see cref="DateTimeParameterType"/>
        /// </summary>
