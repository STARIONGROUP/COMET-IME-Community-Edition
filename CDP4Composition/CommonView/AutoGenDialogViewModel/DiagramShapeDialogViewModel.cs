// -------------------------------------------------------------------------------------------------
// <copyright file="DiagramShapeDialogViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="DiagramShape"/>
    /// </summary>
    public abstract partial class DiagramShapeDialogViewModel<T> : DiagramElementThingDialogViewModel<T> where T : DiagramShape
    {
