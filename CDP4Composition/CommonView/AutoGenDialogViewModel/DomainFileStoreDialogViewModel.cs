// -------------------------------------------------------------------------------------------------
// <copyright file="DomainFileStoreDialogViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="DomainFileStore"/>
    /// </summary>
    public partial class DomainFileStoreDialogViewModel : FileStoreDialogViewModel<DomainFileStore>
    {
        /// <summary>
        ...
        /// </param>
        public DomainFileStoreDialogViewModel(DomainFileStore domainFileStore, IThingTransaction transaction, ISession session, bool isRoot, ThingDialogKind dialogKind, IThingDialogNavigationService thingDialogNavigationService, Thing container, IEnumerable<Thing> chainOfContainers) : base(domainFileStore, transaction, session, isRoot, dialogKind, thingDialogNavigationService, container, chainOfContainers)
        {
            if(container != null)
            {
