// -------------------------------------------------------------------------------------------------
// <copyright file="ElementBaseDialogViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="ElementBase"/>
    /// </summary>
    public abstract partial class ElementBaseDialogViewModel<T> : DefinedThingDialogViewModel<T> where T : ElementBase
    {
        /// <summary>
        ...
        /// </remarks>
        protected ElementBaseDialogViewModel()
        {
        }
