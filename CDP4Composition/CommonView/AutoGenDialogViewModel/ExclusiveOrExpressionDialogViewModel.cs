// -------------------------------------------------------------------------------------------------
// <copyright file="ExclusiveOrExpressionDialogViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="ExclusiveOrExpression"/>
    /// </summary>
    public partial class ExclusiveOrExpressionDialogViewModel : BooleanExpressionDialogViewModel<ExclusiveOrExpression>
    {
        ...
        /// </param>
        public ExclusiveOrExpressionDialogViewModel(ExclusiveOrExpression exclusiveOrExpression, IThingTransaction transaction, ISession session, bool isRoot, ThingDialogKind dialogKind, IThingDialogNavigationService thingDialogNavigationService, Thing container, IEnumerable<Thing> chainOfContainers) : base(exclusiveOrExpression, transaction, session, isRoot, dialogKind, thingDialogNavigationService, container, chainOfContainers)
        {
            if(container != null)
            {
