...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="FileType"/>
    /// </summary>
    public partial class FileTypeDialogViewModel : DefinedThingDialogViewModel<FileType>
    {
        /// <summary>
        ...
        /// </param>
        public FileTypeDialogViewModel(FileType fileType, IThingTransaction transaction, ISession session, bool isRoot, ThingDialogKind dialogKind, IThingDialogNavigationService thingDialogNavigationService, Thing container, IEnumerable<Thing> chainOfContainers) : base(fileType, transaction, session, isRoot, dialogKind, thingDialogNavigationService, container, chainOfContainers)
        {
            if(container != null)
            {
        ...
        /// <summary>
        /// Populate the possible containers for a <see cref="FileType"/>
        /// </summary>
