// -------------------------------------------------------------------------------------------------
// <copyright file="FolderDialogViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// </summary>
    public partial class FolderDialogViewModel : DialogViewModelBase<Folder>
    {
        /// <summary>
        ...
        /// </param>
        public FolderDialogViewModel(Folder folder, IThingTransaction transaction, ISession session, bool isRoot, ThingDialogKind dialogKind, IThingDialogNavigationService thingDialogNavigationService, Thing container, IEnumerable<Thing> chainOfContainers) : base(folder, transaction, session, isRoot, dialogKind, thingDialogNavigationService, container, chainOfContainers)
        {
            if(container != null)
            {
