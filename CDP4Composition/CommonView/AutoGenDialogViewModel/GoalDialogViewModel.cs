// -------------------------------------------------------------------------------------------------
// <copyright file="GoalDialogViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="Goal"/>
    /// </summary>
    public partial class GoalDialogViewModel : DefinedThingDialogViewModel<Goal>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="GoalDialogViewModel"/> class.
        /// </summary>
        /// <remarks>
        /// The default constructor is required by MEF
        /// </remarks>
        public GoalDialogViewModel()
        {
        }
        ...
        /// </summary>
        /// <param name="goal">
        /// The <see cref="Goal"/> that is the subject of the current view-model. This is the object
        ...
        /// </param>
        public GoalDialogViewModel(Goal goal, IThingTransaction transaction, ISession session, bool isRoot, ThingDialogKind dialogKind, IThingDialogNavigationService thingDialogNavigationService, Thing container, IEnumerable<Thing> chainOfContainers) : base(goal, transaction, session, isRoot, dialogKind, thingDialogNavigationService, container, chainOfContainers)
        {
            if(container != null)
            {
