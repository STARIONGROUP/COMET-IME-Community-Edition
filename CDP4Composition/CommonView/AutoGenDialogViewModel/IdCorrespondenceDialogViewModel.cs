// -------------------------------------------------------------------------------------------------
// <copyright file="IdCorrespondenceDialogViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="IdCorrespondence"/>
    /// </summary>
    public partial class IdCorrespondenceDialogViewModel : DialogViewModelBase<IdCorrespondence>
    {
        /// <summary>
        ...
        /// </remarks>
        public IdCorrespondenceDialogViewModel()
        {
        }
        ...
        /// </summary>
        public virtual Guid InternalThing
        {
        ...
        protected override void UpdateTransaction()
        {
            ...
            clone.InternalThing = this.InternalThing;
