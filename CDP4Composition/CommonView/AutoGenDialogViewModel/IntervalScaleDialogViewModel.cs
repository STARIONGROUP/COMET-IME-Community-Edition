...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="IntervalScale"/>
    /// </summary>
    public partial class IntervalScaleDialogViewModel : MeasurementScaleDialogViewModel<IntervalScale>
    {
        ...
        /// The <see cref="IntervalScale"/> that is the subject of the current view-model. This is the object
        ...
        /// </param>
        public IntervalScaleDialogViewModel(IntervalScale intervalScale, IThingTransaction transaction, ISession session, bool isRoot, ThingDialogKind dialogKind, IThingDialogNavigationService thingDialogNavigationService, Thing container, IEnumerable<Thing> chainOfContainers) : base(intervalScale, transaction, session, isRoot, dialogKind, thingDialogNavigationService, container, chainOfContainers)
        {
            if(container != null)
            {
        ...
        /// <summary>
        /// Populate the possible containers for a <see cref="IntervalScale"/>
        /// </summary>
