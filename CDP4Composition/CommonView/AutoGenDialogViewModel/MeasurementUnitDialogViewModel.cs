// -------------------------------------------------------------------------------------------------
// <copyright file="MeasurementUnitDialogViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="MeasurementUnit"/>
    /// </summary>
    public abstract partial class MeasurementUnitDialogViewModel<T> : DefinedThingDialogViewModel<T> where T : MeasurementUnit
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MeasurementUnitDialogViewModel{T}"/> class.
        /// </summary>
        /// <remarks>
        /// The default constructor is required by MEF
        /// </remarks>
        protected MeasurementUnitDialogViewModel()
        {
        }
        ...
        /// The <see cref="MeasurementUnit"/> that is the subject of the current view-model. This is the object
        ...
        /// </param>
        protected MeasurementUnitDialogViewModel(T measurementUnit, IThingTransaction transaction, ISession session, bool isRoot, ThingDialogKind dialogKind, IThingDialogNavigationService thingDialogNavigationService, Thing container, IEnumerable<Thing> chainOfContainers) : base(measurementUnit, transaction, session, isRoot, dialogKind, thingDialogNavigationService, container, chainOfContainers)
        {
            if(container != null)
            {
        ...
        /// <summary>
        /// Populate the possible containers for a <see cref="MeasurementUnit"/>
        /// </summary>
