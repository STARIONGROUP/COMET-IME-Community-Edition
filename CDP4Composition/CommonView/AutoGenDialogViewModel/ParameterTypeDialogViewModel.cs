// -------------------------------------------------------------------------------------------------
// <copyright file="ParameterTypeDialogViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="ParameterType"/>
    /// </summary>
    public abstract partial class ParameterTypeDialogViewModel<T> : DefinedThingDialogViewModel<T> where T : ParameterType
    {
        /// <summary>
        ...
        /// </remarks>
        protected ParameterTypeDialogViewModel()
        {
        }
        ...
        /// <summary>
        /// Populate the possible containers for a <see cref="ParameterType"/>
        /// </summary>
        ...
        /// </summary>
        protected void PopulatePossibleCategories()
        {
