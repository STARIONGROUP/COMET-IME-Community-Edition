// -------------------------------------------------------------------------------------------------
// <copyright file="ParameterValueDialogViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="ParameterValue"/>
    /// </summary>
    public abstract partial class ParameterValueDialogViewModel<T> : DialogViewModelBase<T> where T : ParameterValue
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ParameterValueDialogViewModel{T}"/> class.
        /// </summary>
        /// <remarks>
        /// The default constructor is required by MEF
        /// </remarks>
        protected ParameterValueDialogViewModel()
        {
        }
        ...
        /// The <see cref="ParameterValue"/> that is the subject of the current view-model. This is the object
