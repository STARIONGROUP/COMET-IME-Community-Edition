...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="ParameterizedCategoryRule"/>
    /// </summary>
    public partial class ParameterizedCategoryRuleDialogViewModel : RuleDialogViewModel<ParameterizedCategoryRule>
    {
        /// <summary>
        ...
        /// The <see cref="ParameterizedCategoryRule"/> that is the subject of the current view-model. This is the object
        ...
        /// </param>
        public ParameterizedCategoryRuleDialogViewModel(ParameterizedCategoryRule parameterizedCategoryRule, IThingTransaction transaction, ISession session, bool isRoot, ThingDialogKind dialogKind, IThingDialogNavigationService thingDialogNavigationService, Thing container, IEnumerable<Thing> chainOfContainers) : base(parameterizedCategoryRule, transaction, session, isRoot, dialogKind, thingDialogNavigationService, container, chainOfContainers)
        {
            if(container != null)
            {
        ...
        /// <summary>
        /// Gets or sets the possible <see cref="Category"/>s for <see cref="SelectedCategory"/>
        /// </summary>
        public ReactiveList<Category> PossibleCategory { get; protected set; }
        
        /// <summary>
        /// Backing field for <see cref="ParameterType"/>s
        /// </summary>
        private ReactiveList<ParameterType> parameterType;

        /// <summary>
        /// Gets or sets the list of selected <see cref="ParameterType"/>s
        /// </summary>
        public ReactiveList<ParameterType> ParameterType 
        { 
        ...
        /// <summary>
        /// Gets or sets the Possible <see cref="ParameterType"/> for <see cref="ParameterType"/>
        /// </summary>
        public ReactiveList<ParameterType> PossibleParameterType { get; protected set; }

        /// <summary>
        /// Gets or sets the Inspect <see cref="ICommand"/> to inspect the <see cref="SelectedCategory"/>
        /// </summary>
        public ReactiveCommand<Unit, Unit> InspectSelectedCategoryCommand { get; protected set; }
        ...
        protected override void InitializeCommands()
        {
            ...
            var canExecuteInspectSelectedCategoryCommand = this.WhenAny(vm => vm.SelectedCategory, v => v.Value != null);
            this.InspectSelectedCategoryCommand = ReactiveCommandCreator.Create(canExecuteInspectSelectedCategoryCommand);
            this.InspectSelectedCategoryCommand.Subscribe(_ => this.ExecuteInspectCommand(this.SelectedCategory));
        }
        ...
        protected override void UpdateTransaction()
        {
            ...
            clone.Category = this.SelectedCategory;
            clone.ParameterType.Clear();
            clone.ParameterType.AddRange(this.ParameterType);
        ...
        protected override void Initialize()
        {
            ...
            this.ParameterType = new ReactiveList<ParameterType>();
            this.PossibleParameterType = new ReactiveList<ParameterType>();
            this.PopulatePossibleContainer();
        }

        /// <summary>
        /// Populate the possible containers for a <see cref="ParameterizedCategoryRule"/>
        /// </summary>
        ...
        protected override void UpdateProperties()
        {
            ...
            this.SelectedCategory = this.Thing.Category;
            this.PopulatePossibleCategory();
            this.PopulateParameterType();
        }

        /// <summary>
        /// Populates the <see cref="ParameterType"/> property
        /// </summary>
        protected virtual void PopulateParameterType()
        {
            this.ParameterType.Clear();

            foreach (var value in this.Thing.ParameterType)
            {
                this.ParameterType.Add(value);
            }
        } 

        /// <summary>
        /// Populates the <see cref="PossibleCategory"/> property
        /// </summary>
        protected virtual void PopulatePossibleCategory()
        {
