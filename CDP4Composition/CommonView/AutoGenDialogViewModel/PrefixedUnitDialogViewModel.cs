// -------------------------------------------------------------------------------------------------
// <copyright file="PrefixedUnitDialogViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="PrefixedUnit"/>
    /// </summary>
    public partial class PrefixedUnitDialogViewModel : ConversionBasedUnitDialogViewModel<PrefixedUnit>
    {
        /// <summary>
        /// Backing field for <see cref="SelectedPrefix"/>
        /// </summary>
        private UnitPrefix selectedPrefix;
        ...
        /// </param>
        public PrefixedUnitDialogViewModel(PrefixedUnit prefixedUnit, IThingTransaction transaction, ISession session, bool isRoot, ThingDialogKind dialogKind, IThingDialogNavigationService thingDialogNavigationService, Thing container, IEnumerable<Thing> chainOfContainers) : base(prefixedUnit, transaction, session, isRoot, dialogKind, thingDialogNavigationService, container, chainOfContainers)
        {
            if(container != null)
            {
        ...
        /// <summary>
        /// Gets or sets the SelectedPrefix
        /// </summary>
        public virtual UnitPrefix SelectedPrefix
        {
            get { return this.selectedPrefix; }
            set { this.RaiseAndSetIfChanged(ref this.selectedPrefix, value); }
        }

        /// <summary>
        /// Gets or sets the possible <see cref="UnitPrefix"/>s for <see cref="SelectedPrefix"/>
        /// </summary>
        public ReactiveList<UnitPrefix> PossiblePrefix { get; protected set; }

        /// <summary>
        /// Gets or sets the Inspect <see cref="ICommand"/> to inspect the <see cref="SelectedPrefix"/>
        /// </summary>
        public ReactiveCommand<Unit, Unit> InspectSelectedPrefixCommand { get; protected set; }
        ...
        protected override void InitializeCommands()
        {
            ...
            this.InspectSelectedPrefixCommand = ReactiveCommandCreator.Create(canExecuteInspectSelectedPrefixCommand);
        ...
        {
            base.Initialize();
            this.PossiblePrefix = new ReactiveList<UnitPrefix>();
            this.PopulatePossibleContainer();
        }

        /// <summary>
        /// Populate the possible containers for a <see cref="PrefixedUnit"/>
        /// </summary>
        ...
        /// <summary>
        /// Populates the <see cref="PossiblePrefix"/> property
        /// </summary>
