// -------------------------------------------------------------------------------------------------
// <copyright file="RatioScaleDialogViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="RatioScale"/>
    /// </summary>
    public partial class RatioScaleDialogViewModel : MeasurementScaleDialogViewModel<RatioScale>
    {
        ...
        /// The <see cref="RatioScale"/> that is the subject of the current view-model. This is the object
        ...
        /// </param>
        public RatioScaleDialogViewModel(RatioScale ratioScale, IThingTransaction transaction, ISession session, bool isRoot, ThingDialogKind dialogKind, IThingDialogNavigationService thingDialogNavigationService, Thing container, IEnumerable<Thing> chainOfContainers) : base(ratioScale, transaction, session, isRoot, dialogKind, thingDialogNavigationService, container, chainOfContainers)
        {
            if(container != null)
            {
        ...
        /// <summary>
        /// Populate the possible containers for a <see cref="RatioScale"/>
        /// </summary>
