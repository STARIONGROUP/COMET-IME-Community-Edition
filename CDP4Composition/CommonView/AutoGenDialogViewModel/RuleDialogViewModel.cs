// -------------------------------------------------------------------------------------------------
// <copyright file="RuleDialogViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="Rule"/>
    /// </summary>
    public abstract partial class RuleDialogViewModel<T> : DefinedThingDialogViewModel<T> where T : Rule
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RuleDialogViewModel{T}"/> class.
        /// </summary>
        /// <remarks>
        /// The default constructor is required by MEF
        /// </remarks>
        protected RuleDialogViewModel()
        {
        }
        ...
        /// </summary>
        /// <param name="rule">
        /// The <see cref="Rule"/> that is the subject of the current view-model. This is the object
        ...
        /// </param>
        protected RuleDialogViewModel(T rule, IThingTransaction transaction, ISession session, bool isRoot, ThingDialogKind dialogKind, IThingDialogNavigationService thingDialogNavigationService, Thing container, IEnumerable<Thing> chainOfContainers) : base(rule, transaction, session, isRoot, dialogKind, thingDialogNavigationService, container, chainOfContainers)
        {
            if(container != null)
            {
        ...
        /// <summary>
        /// Populate the possible containers for a <see cref="Rule"/>
        /// </summary>
