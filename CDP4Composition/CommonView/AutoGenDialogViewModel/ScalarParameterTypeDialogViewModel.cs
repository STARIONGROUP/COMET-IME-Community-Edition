// -------------------------------------------------------------------------------------------------
// <copyright file="ScalarParameterTypeDialogViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="ScalarParameterType"/>
    /// </summary>
    public abstract partial class ScalarParameterTypeDialogViewModel<T> : ParameterTypeDialogViewModel<T> where T : ScalarParameterType
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="ScalarParameterTypeDialogViewModel{T}"/> class.
        /// </summary>
        /// <remarks>
        /// The default constructor is required by MEF
        /// </remarks>
        protected ScalarParameterTypeDialogViewModel()
        {
        }
        ...
        /// The <see cref="ScalarParameterType"/> that is the subject of the current view-model. This is the object
        ...
        /// </param>
        protected ScalarParameterTypeDialogViewModel(T scalarParameterType, IThingTransaction transaction, ISession session, bool isRoot, ThingDialogKind dialogKind, IThingDialogNavigationService thingDialogNavigationService, Thing container, IEnumerable<Thing> chainOfContainers) : base(scalarParameterType, transaction, session, isRoot, dialogKind, thingDialogNavigationService, container, chainOfContainers)
        {
            if(container != null)
            {
        ...
        /// <summary>
        /// Populate the possible containers for a <see cref="ScalarParameterType"/>
        /// </summary>
