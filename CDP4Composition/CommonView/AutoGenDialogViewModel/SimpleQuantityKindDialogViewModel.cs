...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="SimpleQuantityKind"/>
    /// </summary>
    public partial class SimpleQuantityKindDialogViewModel : QuantityKindDialogViewModel<SimpleQuantityKind>
    {
        ...
        /// The <see cref="SimpleQuantityKind"/> that is the subject of the current view-model. This is the object
        ...
        /// </param>
        public SimpleQuantityKindDialogViewModel(SimpleQuantityKind simpleQuantityKind, IThingTransaction transaction, ISession session, bool isRoot, ThingDialogKind dialogKind, IThingDialogNavigationService thingDialogNavigationService, Thing container, IEnumerable<Thing> chainOfContainers) : base(simpleQuantityKind, transaction, session, isRoot, dialogKind, thingDialogNavigationService, container, chainOfContainers)
        {
            if(container != null)
            {
        ...
        /// <summary>
        /// Populate the possible containers for a <see cref="SimpleQuantityKind"/>
        /// </summary>
