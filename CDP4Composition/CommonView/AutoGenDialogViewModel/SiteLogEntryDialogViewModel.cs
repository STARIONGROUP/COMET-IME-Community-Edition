// -------------------------------------------------------------------------------------------------
// <copyright file="SiteLogEntryDialogViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="SiteLogEntry"/>
    /// </summary>
    public partial class SiteLogEntryDialogViewModel : DialogViewModelBase<SiteLogEntry>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SiteLogEntryDialogViewModel"/> class.
        /// </summary>
        /// <remarks>
        /// The default constructor is required by MEF
        /// </remarks>
        public SiteLogEntryDialogViewModel()
        {
        }
        ...
        /// The <see cref="SiteLogEntry"/> that is the subject of the current view-model. This is the object
        ...
        /// </param>
        public SiteLogEntryDialogViewModel(SiteLogEntry siteLogEntry, IThingTransaction transaction, ISession session, bool isRoot, ThingDialogKind dialogKind, IThingDialogNavigationService thingDialogNavigationService, Thing container, IEnumerable<Thing> chainOfContainers) : base(siteLogEntry, transaction, session, isRoot, dialogKind, thingDialogNavigationService, container, chainOfContainers)
        {
            if(container != null)
            {
