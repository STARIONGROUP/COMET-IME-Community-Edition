// -------------------------------------------------------------------------------------------------
// <copyright file="StakeholderDialogViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="Stakeholder"/>
    /// </summary>
    public partial class StakeholderDialogViewModel : DefinedThingDialogViewModel<Stakeholder>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="StakeholderDialogViewModel"/> class.
        /// </summary>
        /// <remarks>
        /// The default constructor is required by MEF
        /// </remarks>
        public StakeholderDialogViewModel()
        {
        }
        ...
        /// The <see cref="Stakeholder"/> that is the subject of the current view-model. This is the object
        ...
        /// </param>
        public StakeholderDialogViewModel(Stakeholder stakeholder, IThingTransaction transaction, ISession session, bool isRoot, ThingDialogKind dialogKind, IThingDialogNavigationService thingDialogNavigationService, Thing container, IEnumerable<Thing> chainOfContainers) : base(stakeholder, transaction, session, isRoot, dialogKind, thingDialogNavigationService, container, chainOfContainers)
        {
            if(container != null)
            {
