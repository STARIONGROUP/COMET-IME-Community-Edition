// -------------------------------------------------------------------------------------------------
// <copyright file="StakeholderValueDialogViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="StakeholderValue"/>
    /// </summary>
    public partial class StakeholderValueDialogViewModel : DefinedThingDialogViewModel<StakeholderValue>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="StakeholderValueDialogViewModel"/> class.
        /// </summary>
        /// <remarks>
        /// The default constructor is required by MEF
        /// </remarks>
        public StakeholderValueDialogViewModel()
        {
        }
        ...
        /// The <see cref="StakeholderValue"/> that is the subject of the current view-model. This is the object
        ...
        /// </param>
        public StakeholderValueDialogViewModel(StakeholderValue stakeholderValue, IThingTransaction transaction, ISession session, bool isRoot, ThingDialogKind dialogKind, IThingDialogNavigationService thingDialogNavigationService, Thing container, IEnumerable<Thing> chainOfContainers) : base(stakeholderValue, transaction, session, isRoot, dialogKind, thingDialogNavigationService, container, chainOfContainers)
        {
            if(container != null)
            {
