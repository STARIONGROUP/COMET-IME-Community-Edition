// -------------------------------------------------------------------------------------------------
// <copyright file="TextParameterTypeDialogViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="TextParameterType"/>
    /// </summary>
    public partial class TextParameterTypeDialogViewModel : ScalarParameterTypeDialogViewModel<TextParameterType>
    {
        ...
        /// The <see cref="TextParameterType"/> that is the subject of the current view-model. This is the object
        ...
        /// </param>
        public TextParameterTypeDialogViewModel(TextParameterType textParameterType, IThingTransaction transaction, ISession session, bool isRoot, ThingDialogKind dialogKind, IThingDialogNavigationService thingDialogNavigationService, Thing container, IEnumerable<Thing> chainOfContainers) : base(textParameterType, transaction, session, isRoot, dialogKind, thingDialogNavigationService, container, chainOfContainers)
        {
            if(container != null)
            {
        ...
        /// <summary>
        /// Populate the possible containers for a <see cref="TextParameterType"/>
        /// </summary>
