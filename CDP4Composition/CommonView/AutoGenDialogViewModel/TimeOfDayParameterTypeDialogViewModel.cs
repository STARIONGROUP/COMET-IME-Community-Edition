// -------------------------------------------------------------------------------------------------
// <copyright file="TimeOfDayParameterTypeDialogViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="TimeOfDayParameterType"/>
    /// </summary>
    public partial class TimeOfDayParameterTypeDialogViewModel : ScalarParameterTypeDialogViewModel<TimeOfDayParameterType>
    {
        ...
        /// </param>
        public TimeOfDayParameterTypeDialogViewModel(TimeOfDayParameterType timeOfDayParameterType, IThingTransaction transaction, ISession session, bool isRoot, ThingDialogKind dialogKind, IThingDialogNavigationService thingDialogNavigationService, Thing container, IEnumerable<Thing> chainOfContainers) : base(timeOfDayParameterType, transaction, session, isRoot, dialogKind, thingDialogNavigationService, container, chainOfContainers)
        {
            if(container != null)
            {
        ...
        /// <summary>
        /// Populate the possible containers for a <see cref="TimeOfDayParameterType"/>
        /// </summary>
