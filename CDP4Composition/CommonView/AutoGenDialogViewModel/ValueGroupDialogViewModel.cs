// -------------------------------------------------------------------------------------------------
// <copyright file="ValueGroupDialogViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// dialog-view-model class representing a <see cref="ValueGroup"/>
    /// </summary>
    public partial class ValueGroupDialogViewModel : DefinedThingDialogViewModel<ValueGroup>
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="ValueGroupDialogViewModel"/> class.
        /// </summary>
        /// <remarks>
        /// The default constructor is required by MEF
        /// </remarks>
        public ValueGroupDialogViewModel()
        {
        }
        ...
        /// The <see cref="ValueGroup"/> that is the subject of the current view-model. This is the object
        ...
        /// </param>
        public ValueGroupDialogViewModel(ValueGroup valueGroup, IThingTransaction transaction, ISession session, bool isRoot, ThingDialogKind dialogKind, IThingDialogNavigationService thingDialogNavigationService, Thing container, IEnumerable<Thing> chainOfContainers) : base(valueGroup, transaction, session, isRoot, dialogKind, thingDialogNavigationService, container, chainOfContainers)
        {
            if(container != null)
            {
