// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BinaryNoteRowViewModel.cs" company="RHEA System S.A.">
...
namespace CDP4CommonView
{
    ...
    {
        /// <summary>
        /// Backing field for <see cref="Caption"/> property
        /// </summary>
        private string caption;

        /// <summary>
        /// Backing field for <see cref="FileType"/> property
        /// </summary>
        private FileType fileType;

        /// <summary>
        /// Backing field for <see cref="FileTypeName"/> property
        /// </summary>
        private string fileTypeName;

        /// <summary>
        /// Backing field for <see cref="FileTypeShortName"/> property
        /// </summary>
