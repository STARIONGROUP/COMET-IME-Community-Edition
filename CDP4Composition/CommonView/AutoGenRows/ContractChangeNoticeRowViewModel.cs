// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ContractChangeNoticeRowViewModel.cs" company="RHEA System S.A.">
...
namespace CDP4CommonView
{
    ...
    {
        /// <summary>
        /// Backing field for <see cref="ChangeProposal"/> property
        /// </summary>
        private ChangeProposal changeProposal;

        /// <summary>
        /// Backing field for <see cref="ChangeProposalShortName"/> property
        /// </summary>
        ...
        /// </summary>
        public ChangeProposal ChangeProposal
        {
            get { return this.changeProposal; }
            set { this.RaiseAndSetIfChanged(ref this.changeProposal, value); }
        }

        /// <summary>
        /// Gets or set the ShortName of <see cref="ChangeProposal"/>
        /// </summary>
