...
namespace CDP4CommonView
{
    ...
    public abstract partial class ConversionBasedUnitRowViewModel<T> : MeasurementUnitRowViewModel<T> where T : ConversionBasedUnit
    {
        ...
        /// <summary>
        /// Backing field for <see cref="ReferenceUnit"/> property
        /// </summary>
        private MeasurementUnit referenceUnit;

        /// <summary>
        /// Backing field for <see cref="ReferenceUnitName"/> property
        /// </summary>
        private string referenceUnitName;

        /// <summary>
        /// Backing field for <see cref="ReferenceUnitShortName"/> property
        /// </summary>
