// -------------------------------------------------------------------------------------------------
// <copyright file="DiscussionItemRowViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// </summary>
    public abstract partial class DiscussionItemRowViewModel<T> : GenericAnnotationRowViewModel<T> where T : DiscussionItem
    {

        /// <summary>
        /// Backing field for <see cref="ReplyTo"/>
        /// </summary>
