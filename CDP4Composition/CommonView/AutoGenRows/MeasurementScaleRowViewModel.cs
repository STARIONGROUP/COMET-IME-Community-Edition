...
namespace CDP4CommonView
{
    ...
    public abstract partial class MeasurementScaleRowViewModel<T> : DefinedThingRowViewModel<T> where T : MeasurementScale
    {
        ...
        /// <summary>
        /// Backing field for <see cref="IsMaximumInclusive"/> property
        /// </summary>
        private bool isMaximumInclusive;

        /// <summary>
        /// Backing field for <see cref="IsMinimumInclusive"/> property
        /// </summary>
        private bool isMinimumInclusive;

        /// <summary>
        /// Backing field for <see cref="MaximumPermissibleValue"/> property
        /// </summary>
        private string maximumPermissibleValue;

        /// <summary>
        /// Backing field for <see cref="MinimumPermissibleValue"/> property
        /// </summary>
        private string minimumPermissibleValue;

        /// <summary>
        /// Backing field for <see cref="NegativeValueConnotation"/> property
        /// </summary>
        private string negativeValueConnotation;

        /// <summary>
        /// Backing field for <see cref="NumberSet"/> property
        /// </summary>
        private NumberSetKind numberSet;

        /// <summary>
        /// Backing field for <see cref="PositiveValueConnotation"/> property
        /// </summary>
        private string positiveValueConnotation;

        /// <summary>
        /// Backing field for <see cref="Unit"/> property
        /// </summary>
        private MeasurementUnit unit;

        /// <summary>
        /// Backing field for <see cref="UnitName"/> property
        /// </summary>
        private string unitName;

        /// <summary>
        /// Backing field for <see cref="UnitShortName"/> property
        /// </summary>
