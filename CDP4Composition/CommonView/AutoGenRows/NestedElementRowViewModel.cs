...
namespace CDP4CommonView
{
    ...
    public partial class NestedElementRowViewModel : RowViewModelBase<NestedElement>
    {
        ...
        /// <summary>
        /// Backing field for <see cref="RootElement"/> property
        /// </summary>
        private ElementDefinition rootElement;

        /// <summary>
        /// Backing field for <see cref="RootElementName"/> property
        /// </summary>
        private string rootElementName;

        /// <summary>
        /// Backing field for <see cref="RootElementShortName"/> property
        /// </summary>
