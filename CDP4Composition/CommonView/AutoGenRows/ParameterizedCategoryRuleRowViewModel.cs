// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterizedCategoryRuleRowViewModel.cs" company="RHEA System S.A.">
...
namespace CDP4CommonView
{
    ...
    public partial class ParameterizedCategoryRuleRowViewModel : RuleRowViewModel<ParameterizedCategoryRule>
    {
        ...
        /// <summary>
        /// Backing field for <see cref="CategoryName"/> property
        /// </summary>
        private string categoryName;

        /// <summary>
        /// Backing field for <see cref="CategoryShortName"/> property
        /// </summary>
        ...
        private void UpdateProperties()
        {
            ...
            if (this.Thing.Category != null)
            {
                this.CategoryName = this.Thing.Category.Name;
                this.CategoryShortName = this.Thing.Category.ShortName;
            }
            else
            {
                this.CategoryName = string.Empty;
                this.CategoryShortName = string.Empty;
            }
        }
    }
}
