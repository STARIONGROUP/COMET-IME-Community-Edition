...
namespace CDP4CommonView
{
    ...
    {
        /// <summary>
        /// Backing field for <see cref="DefaultState"/> property
        /// </summary>
        private PossibleFiniteState defaultState;

        /// <summary>
        /// Backing field for <see cref="DefaultStateName"/> property
        /// </summary>
        private string defaultStateName;

        /// <summary>
        /// Backing field for <see cref="DefaultStateShortName"/> property
        /// </summary>
        ...
        private void UpdateProperties()
        {
            ...
            if (this.Thing.DefaultState != null)
            {
                this.DefaultStateName = this.Thing.DefaultState.Name;
                this.DefaultStateShortName = this.Thing.DefaultState.ShortName;
            }
            else
            {
                this.DefaultStateName = string.Empty;
                this.DefaultStateShortName = string.Empty;
            }
