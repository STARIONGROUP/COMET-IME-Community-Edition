// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PrefixedUnitRowViewModel.cs" company="RHEA System S.A.">
...
namespace CDP4CommonView
{
    ...
    public partial class PrefixedUnitRowViewModel : ConversionBasedUnitRowViewModel<PrefixedUnit>
    {
        ...
        /// <summary>
        /// Backing field for <see cref="Prefix"/> property
        /// </summary>
        private UnitPrefix prefix;

        /// <summary>
        /// Backing field for <see cref="PrefixName"/> property
        /// </summary>
        private string prefixName;

        /// <summary>
        /// Backing field for <see cref="PrefixShortName"/> property
        /// </summary>
        ...
        private void UpdateProperties()
        {
            ...
            {
                this.PrefixName = string.Empty;
                this.PrefixShortName = string.Empty;
            }
