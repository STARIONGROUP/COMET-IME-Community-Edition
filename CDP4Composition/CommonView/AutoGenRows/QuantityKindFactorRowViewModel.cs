...
namespace CDP4CommonView
{
    ...
    public partial class QuantityKindFactorRowViewModel : RowViewModelBase<QuantityKindFactor>
    {
        ...
        /// <summary>
        /// Backing field for <see cref="QuantityKind"/> property
        /// </summary>
        private QuantityKind quantityKind;

        /// <summary>
        /// Backing field for <see cref="QuantityKindName"/> property
        /// </summary>
        private string quantityKindName;

        /// <summary>
        /// Backing field for <see cref="QuantityKindShortName"/> property
        /// </summary>
        ...
        private void UpdateProperties()
        {
            ...
            {
                this.QuantityKindName = string.Empty;
                this.QuantityKindShortName = string.Empty;
            }
        }
    }
}
