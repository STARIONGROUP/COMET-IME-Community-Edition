// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TopContainerRowViewModel.cs" company="RHEA System S.A.">
...
namespace CDP4CommonView
{
    ...
    /// </summary>
    public abstract partial class TopContainerRowViewModel<T> : RowViewModelBase<T> where T : TopContainer
    {
        /// <summary>
        /// Backing field for <see cref="LastModifiedOn"/> property
        /// </summary>
