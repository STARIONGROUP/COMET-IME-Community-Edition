// -------------------------------------------------------------------------------------------------
// <copyright file="UnitPrefixRowViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CommonView
{
    ...
    /// <summary>
    /// Row class representing a <see cref="UnitPrefix"/>
    /// </summary>
    public partial class UnitPrefixRowViewModel : DefinedThingRowViewModel<UnitPrefix>
    {
        ...
        /// </summary>
        /// <param name="unitPrefix">The <see cref="UnitPrefix"/> associated with this row</param>
        /// <param name="session">The session</param>
        /// <param name="containerViewModel">The <see cref="IViewModelBase{Thing}"/> that is the container of this <see cref="IRowViewModelBase{Thing}"/></param>
        public UnitPrefixRowViewModel(UnitPrefix unitPrefix, ISession session, IViewModelBase<Thing> containerViewModel) : base(unitPrefix, session, containerViewModel)
        {
