// -------------------------------------------------------------------------------------------------
// <copyright file="DiagramPortShapeBehavior.cs" company="Starion Group S.A.">
        ...
        public void DeterminePortConnectorRotation()
        {
            ...
            switch (this.viewModel.PortContainerShapeSide)
            {
                ...
                case PortContainerShapeSide.Bottom:
                    break;
                default:
                    throw new NotImplementedException($"{this.viewModel.PortContainerShapeSide.ToString()} was not implemented.");
            }
        }
    }
}
