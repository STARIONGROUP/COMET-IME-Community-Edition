...
namespace CDP4CommonView.Diagram
{
    ...
    ////    {
    ////        var connectorView = (Cdp4DiagramConnector)d;
    ////        var oldSource = e.OldValue as ThingDiagramContentItemViewModel;
    ////        var newSource = e.NewValue as ThingDiagramContentItemViewModel;
    ...
    ////    /// </summary>
    ////    public Cdp4DiagramConnector(IDiagramConnectorViewModel dataContext, Cdp4DiagramBehavior behaviour, DiagramConnector baseConnector = null)
    ////    {
    ...
    ////        var diagramObject = diagramControl.Items.OfType<DiagramContentItem>().SingleOrDefault(x => ((NamedThingDiagramContentItemViewModel)x.Content).DiagramThing == source);
