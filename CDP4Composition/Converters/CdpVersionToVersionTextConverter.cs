...
namespace CDP4Composition
{
    ...
    /// <summary>
    /// The purpose of the <see cref="CdpVersionToVersionTextConverter"/> is to convert the <see cref="CDPVersionAttribute.Version"/> version that is used
    /// to decorate the property of a view-model to a NullText value based on the <see cref="ISession.DalVersion"/> that is active.
    /// </summary>
    public class CdpVersionToVersionTextConverter : IValueConverter
    {
        /// <summary>
        /// Converts the  CDP Version string to a NullText value
        /// </summary>
        /// <param name="value">an instance of <see cref="IISession"/></param>
        /// <param name="targetType">The targetType is not used</param>
        /// <param name="parameter">The name of the property that is used to determine NullText of the control</param>
        /// <param name="culture">The culture is not used</param>
        /// <returns>The NUll text value based on the provided CDPVersion</returns>
