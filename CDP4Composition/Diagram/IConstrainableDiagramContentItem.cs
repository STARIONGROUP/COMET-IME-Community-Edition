// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IConstrainableDiagramContentItem.cs" company="RHEA System S.A.">
...
namespace CDP4Composition.Diagram
{
    ...
    /// <summary>
    /// Defines a type of vm that can have constraints created between them
    /// </summary>
    public interface IConstrainableDiagramContentItem
    {
        /// <summary>
