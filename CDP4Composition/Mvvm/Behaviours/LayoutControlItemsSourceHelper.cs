// -------------------------------------------------------------------------------------------------
// <copyright file="LayoutControlItemsSourceHelper.cs" company="Starion Group S.A.">
...
namespace CDP4Composition.Mvvm.Behaviours
{
    ...
    /// <summary>
    /// A behaviour to add the "ItemsSource" functionality to a <see cref="LayoutControl"/>. That allows dynamic declaration of <see cref="LayoutItem"/> for a <see cref="LayoutControl"/>
    /// </summary>
    public class LayoutControlItemsSourceHelper : Behavior<LayoutControl>
    {
        /// <summary>
        /// The "ItemTemplateSelector" <see cref="DependencyProperty"/> for the dynamic <see cref="LayoutItem"/>
        /// </summary>
        public static readonly DependencyProperty ItemTemplateSelectorProperty =
           DependencyProperty.Register("ItemTemplateSelector", typeof(DataTemplateSelector), typeof(LayoutControlItemsSourceHelper), new PropertyMetadata());

        /// <summary>
        /// The "ItemTemplate" <see cref="DependencyProperty"/> to use for the dynamic <see cref="LayoutItem"/>
        /// </summary>
        public static readonly DependencyProperty ItemTemplateProperty =
          DependencyProperty.Register("ItemTemplate", typeof(DataTemplate), typeof(LayoutControlItemsSourceHelper), new PropertyMetadata());
        ...
        public static readonly DependencyProperty ItemsSourceProperty =
           DependencyProperty.Register("ItemsSource", typeof(IEnumerable), typeof(LayoutControlItemsSourceHelper), new PropertyMetadata((d, e) => ((LayoutControlItemsSourceHelper)d).OnItemsSourceChanged(e)));
        ...
        /// <summary>
        /// Gets the current <see cref="LayoutControl"/>
        /// </summary>
        protected LayoutControl LayoutControl { get { return this.AssociatedObject; } }

        /// <summary>
        /// Gets the children of this <see cref="LayoutControl"/>
        /// </summary>
        protected UIElementCollection Children { get { return this.LayoutControl.Children; } }
        ...
        protected virtual void OnItemsSourceChanged(DependencyPropertyChangedEventArgs e)
        {
            ...
            var value = e.NewValue as INotifyCollectionChanged;
            if (value != null)
            {
                value.CollectionChanged += this.OnItemsSourceCollectionChanged;
            }
        ...
        /// <summary>
        /// Rearrange the children of this <see cref="LayoutControl"/>
        /// </summary>
        ...
        /// <summary>
        /// Removes a <see cref="LayoutItem"/> from this <see cref="LayoutControl"/>
        /// </summary>
        ...
        /// <summary>
        /// Add a new <see cref="LayoutItem"/> to this <see cref="LayoutControl"/>
        /// </summary>
        /// <param name="item">The associated data-context</param>
