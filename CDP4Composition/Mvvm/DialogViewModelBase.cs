...
namespace CDP4Composition.Mvvm
{
    ...
    public abstract class DialogViewModelBase<T> : ViewModelBase<T>, IDialogViewModelBase<T> where T : Thing
    {
        ...
        protected virtual void InitializeCommands()
        {
            ...
            this.Disposables.Add(this.OkCommand.ThrownExceptions.Select(ex => ex).Subscribe(
                x =>
                {
            ...
            this.Disposables.Add(this.CancelCommand.Subscribe(_ => this.ExecuteCancelCommand()));

            this.CopyUriCommand = ReactiveCommand.Create();
            this.Disposables.Add(this.CopyUriCommand.Subscribe(_ => this.ExecuteCopyUriCommand()));

            this.ShallowExportCommand = ReactiveCommand.Create();
            this.Disposables.Add(this.ShallowExportCommand.Subscribe(_ => this.ExecuteShallowExportCommand()));

            this.DeepExportCommand = ReactiveCommand.Create();
            this.Disposables.Add(this.DeepExportCommand.Subscribe(_ => this.ExecuteDeepExportCommand()));

            this.InspectSelectedContainerCommand = ReactiveCommand.Create();
            this.Disposables.Add(this.InspectSelectedContainerCommand.Subscribe(_ => this.ExecuteInspectCommand(this.Container)));
        }
