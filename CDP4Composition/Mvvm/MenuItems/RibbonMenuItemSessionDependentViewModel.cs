// -------------------------------------------------------------------------------------------------
// <copyright file="RibbonMenuItemSessionDependentViewModel.cs" company="RHEA System S.A.">
...
namespace CDP4Composition.Mvvm
{
    ...
    public class RibbonMenuItemSessionDependentViewModel : RibbonMenuItemViewModelBase
    {
        ...
        /// </summary>
        private readonly Func<ISession, IThingDialogNavigationService, IPanelNavigationService, IDialogNavigationService, IPanelViewModel> InstantiatePanelViewModelFunction;
        ...
        public RibbonMenuItemSessionDependentViewModel(string menuItemContent, ISession session, Func<ISession, IThingDialogNavigationService, IPanelNavigationService, IDialogNavigationService, IPanelViewModel> instantiatePanelViewModelFunction)
        ...
        {
            return this.InstantiatePanelViewModelFunction(this.Session, this.ThingDialogNavigationService, this.PanelNavigationServive, this.DialogNavigationService);
        }
    }
}