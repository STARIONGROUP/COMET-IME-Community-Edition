// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RibbonMenuItemViewModelBase.cs" company="Starion Group S.A.">
...
namespace CDP4Composition.Mvvm
{
    ...
    public abstract class RibbonMenuItemViewModelBase : ReactiveObject, IDisposable
    {
        ...
        protected RibbonMenuItemViewModelBase(string menuItemContent, ISession session)
        {
            ...
            this.ShowPanelCommand = ReactiveCommandCreator.Create(this.ExecuteShowPanel);

            this.ClosePanelsCommand = ReactiveCommandCreator.Create(this.ExecuteClosePanels);

            this.Session.CDPMessageBus.Listen<NavigationPanelEvent>()
        ...
        /// </summary>
        public ReactiveCommand<Unit, Unit> ShowPanelCommand { get; private set; }

        /// <summary>
        /// Gets the command to close browser panels
        /// </summary>
        public ReactiveCommand<Unit, Unit> ClosePanelsCommand { get; private set; }
