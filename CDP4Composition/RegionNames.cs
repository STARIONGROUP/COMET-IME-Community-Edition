// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RegionNames.cs" company="Starion Group S.A.">
...
{
    /// <summary>
    /// Definition of the names of the regions
    /// </summary>
    public static class RegionNames
    {
        ...
        /// </summary>
        public const string HomeRibbonPageRegion = "HomeRibbonPageRegion";

        /// <summary>
        /// Defines the "View" Ribbon page region
        /// </summary>
        public const string ViewRibbonPageRegion = "ViewRibbonPageRegion";
