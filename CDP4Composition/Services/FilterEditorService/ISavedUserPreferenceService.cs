// -------------------------------------------------------------------------------------------------
// <copyright file="ISavedUserPreferenceService.cs" company="Starion Group S.A.">
...
namespace CDP4Composition.Services.FilterEditorService
{
    ...
    /// </summary>
    public interface ISavedUserPreferenceService
    {
        /// <summary>
        ...
        Task SaveUserPreference<T>(ISession session, string userPreferenceKey, T userPreferenceValue) where T : class;
    }
}
