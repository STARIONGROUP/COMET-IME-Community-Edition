...
namespace CDP4Composition.ViewModels
{
    ...
    public abstract class ValueSetDialogViewModel : DialogViewModelBase
    {
        ...
        /// </summary>
        public ReactiveList<SubmitParameterRowViewModel> ParameterOrOverrideSubmitParameterRowViewModels { get; private set; }

        /// <summary>
        /// Gets the <see cref="SubmitParameterRowViewModel"/> that represent subscriptions that have been changed in the workbook.
        /// </summary>
        public ReactiveList<SubmitParameterRowViewModel> ParameterSubscriptionSubmitParameterRowViewModels { get; private set; }
