// --------------------------------------------------------------------------------------------------------------------
// <copyright file="WorkbookRowViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4CrossViewEditor.ViewModels
{
    ...
    public class WorkbookRowViewModel
    {
        ...
        public WorkbookRowViewModel(Workbook workbook)
        {
            ...
            this.Path = workbook.Path == string.Empty ? CrossviewSheetConstants.CrossviewSheetName : workbook.Path;
        }
