...
namespace CDP4DashboardModule
{
    ...
    /// </summary>
    [ModuleExportName(typeof(CDP4DashboardModule), "Dashboard Module")]
    public class CDP4DashboardModule : IModule
    {
        ...
        public CDP4DashboardModule(IRegionManager regionManager, IFluentRibbonManager ribbonManager, IPanelNavigationService panelNavigationService, IDialogNavigationService dialogNavigationService, IThingDialogNavigationService thingDialogNavigationService)
        {
        ...
        /// <summary>
        /// Gets the <see cref="IRegionManager"/> that is used by the <see cref="CDP4DashboardModule"/> to register the regions
        /// </summary>
        ...
        {
            this.RegionManager.RegisterViewWithRegion(RegionNames.RibbonRegion, typeof(DashboardBrowserRibbon));
        }
    }
}