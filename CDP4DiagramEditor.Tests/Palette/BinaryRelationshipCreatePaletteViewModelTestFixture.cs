// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BinaryRelationshipCreatePaletteViewModelTestFixture.cs" company="RHEA System S.A.">
...
namespace CDP4DiagramEditor.Tests.Palette
{
    ...
    [TestFixture]
    public class BinaryRelationshipCreatePaletteViewModelTestFixture
    {
        ...
        private BinaryRelationshipCreatePaletteItemViewModel vm;
        ...
        [Test]
        public void VerifyCreateBinaryRelationship()
        {
            this.vm = new BinaryRelationshipCreatePaletteItemViewModel();
            this.vm.BindEditor(this.editor.Object, this.palette);

            Assert.DoesNotThrowAsync(async () => await this.vm.ExecuteAsyncCommand());
        }
    }
}
