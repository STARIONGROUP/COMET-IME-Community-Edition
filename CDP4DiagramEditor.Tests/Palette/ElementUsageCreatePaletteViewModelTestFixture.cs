// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ElementUsageCreatePaletteViewModelTestFixture.cs" company="RHEA System S.A.">
...
namespace CDP4DiagramEditor.Tests.Palette
{
    ...
    [TestFixture]
    public class ElementUsageCreatePaletteViewModelTestFixture
    {
        ...
        private ElementUsageCreatePaletteItemViewModel vm;
        ...
        [Test]
        public void VerifyCreateElementUsage()
        {
            this.vm = new ElementUsageCreatePaletteItemViewModel();
