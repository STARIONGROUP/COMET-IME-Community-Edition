// --------------------------------------------------------------------------------------------------------------------
// <copyright file="InterfaceCreatePaletteViewModelTestFixture.cs" company="RHEA System S.A.">
...
namespace CDP4DiagramEditor.Tests.Palette
{
    ...
    [TestFixture]
    public class InterfaceCreatePaletteViewModelTestFixture
    {
        ...
        private InterfaceCreatePaletteItemViewModel vm;
        ...
        [Test]
        public void VerifyCreateInterface()
        {
            this.vm = new InterfaceCreatePaletteItemViewModel();
