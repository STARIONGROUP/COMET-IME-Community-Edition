// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PortCreatePaletteViewModelTestFixture.cs" company="RHEA System S.A.">
...
namespace CDP4DiagramEditor.Tests.Palette
{
    ...
    [TestFixture]
    public class PortCreatePaletteViewModelTestFixture
    {
        [SetUp]
        public void Setup()
        {
        ...
        private InputPortCreatePaletteItemViewModel vmI;
        private OutputPortCreatePaletteItemViewModel vmO;
        private InOutPortCreatePaletteItemViewModel vmIO;
        private UndirectedPortCreatePaletteItemViewModel vmU;
        ...
        [Test]
        public void VerifyCreateInputOutputPort()
        {
            this.vmIO = new InOutPortCreatePaletteItemViewModel();
            this.vmIO.BindEditor(this.editor.Object, this.palette);

            Assert.DoesNotThrowAsync(async () => await this.vmIO.ExecuteAsyncCommand());
        }

        [Test]
        public void VerifyCreateInputPort()
        {
            this.vmI = new InputPortCreatePaletteItemViewModel();
            this.vmI.BindEditor(this.editor.Object, this.palette);

            Assert.DoesNotThrowAsync(async () => await this.vmI.ExecuteAsyncCommand());
        }

        [Test]
        public void VerifyCreateOutputPort()
        {
            this.vmO = new OutputPortCreatePaletteItemViewModel();
            this.vmO.BindEditor(this.editor.Object, this.palette);

            Assert.DoesNotThrowAsync(async () => await this.vmO.ExecuteAsyncCommand());
        }

        [Test]
        public void VerifyCreateUndirectedPort()
        {
            this.vmU = new UndirectedPortCreatePaletteItemViewModel();
            this.vmU.BindEditor(this.editor.Object, this.palette);

            Assert.DoesNotThrowAsync(async () => await this.vmU.ExecuteAsyncCommand());
        }
    }
}
