// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IViewChangedEventUsingCapable.cs" company="RHEA System S.A.">
...
{
    /// <summary>
    /// te <see cref="IViewChangedEventUsingCapable"/> interface allows object implementing it
    /// to send message to view models through the <see cref="CDP4Dal.CDPMessageBus"/> />
    /// </summary>
