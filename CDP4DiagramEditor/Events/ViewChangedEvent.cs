// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ViewChangedEvent.cs" company="RHEA System S.A.">
...
{
    /// <summary>
    /// Used to identify the message kind used by <see cref="ViewChangedEvent"/>
    /// </summary>
    ...
    public class ViewChangedEvent
    {
        ...
        /// </summary>
        /// <param name="control">
        /// The payload <see cref="IViewChangedEventUsingCapable" />
        /// </param>
        ...
        /// <summary>
        /// Gets or sets the changed <see cref="IViewChangedEventUsingCapable" />
        /// </summary>
