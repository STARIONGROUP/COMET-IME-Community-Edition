...
namespace CDP4DiagramEditor.ViewModels
{
    ...
    public class ConnectorViewModelTemplateSelector : DataTemplateSelector
    {
        ...
        /// <summary>
        /// Gets or sets the <see cref="DataTemplate"/> for a DiagramContentItem that represents a simple connection
        /// </summary>
        public DataTemplate SimpleDataTemplate { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="DataTemplate"/> for a DiagramContentItem that represents a constraint
        /// </summary>
