// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DiagramEditorRibbonViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4DiagramEditor.ViewModels
{
    ...
    public class DiagramEditorRibbonViewModel : RibbonButtonIterationDependentViewModel
    {
        ...
        /// </param>
        public DiagramEditorRibbonViewModel(ICDPMessageBus messageBus) : base(InstantiatePanelViewModel, messageBus)
        {
        }
