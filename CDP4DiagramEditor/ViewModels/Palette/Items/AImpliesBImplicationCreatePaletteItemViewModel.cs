// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AImpliesBImplicationCreatePaletteItemViewModel.cs" company="RHEA System S.A.">
...
namespace CDP4DiagramEditor.ViewModels.Palette
{
    ...
    /// <summary>
    /// Diagram palette button responsible for creating new A implies B implication
    /// </summary>
    [Export(typeof(IPaletteItemViewModel))]
    public class AImpliesBImplicationCreatePaletteItemViewModel : ImplicationCreatePaletteItemViewModel<AImpliesBConnectorTool>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AImpliesBImplicationCreatePaletteItemViewModel" /> class.
        /// </summary>
        public AImpliesBImplicationCreatePaletteItemViewModel() : base(ImplicationKind.AImpliesB)
        {
        }
        ...
        {
            get { return "a_implies_b_16x16.png"; }
        }
    }
}
