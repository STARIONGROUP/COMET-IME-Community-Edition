...
namespace CDP4DiagramEditor.ViewModels.Palette
{
    ...
    public class ElementDefinitionCreatePaletteItemViewModel : PaletteItemBaseViewModel
    {
        /// <summary>
        /// Gets the label text
        /// </summary>
        ...
        {
            // initiate click response and wait for coords

            // pop ED dialog to create a new ED

            // if success create and bind the object
        }
    }
}
