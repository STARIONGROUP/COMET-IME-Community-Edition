// --------------------------------------------------------------------------------------------------------------------
// <copyright file="InOutPortCreatePaletteItemViewModel.cs" company="RHEA System S.A.">
...
namespace CDP4DiagramEditor.ViewModels.Palette
{
    ...
    /// <summary>
    /// Diagram palette button responsible for creating new InOut port
    /// </summary>
    [Export(typeof(IPaletteItemViewModel))]
    public class InOutPortCreatePaletteItemViewModel : PortCreateBasePaletteItemViewModel
    {
        /// <summary>
        /// Gets the label text
        /// </summary>
        ...
        {
            get { return "GoToHeader_16x16.png"; }
        }
        ...
        {
            await this.CreatePort(InterfaceEndKind.IN_OUT);
        }
    }
}
