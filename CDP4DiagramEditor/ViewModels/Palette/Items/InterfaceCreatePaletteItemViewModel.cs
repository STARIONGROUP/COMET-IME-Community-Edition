// --------------------------------------------------------------------------------------------------------------------
// <copyright file="InterfaceCreatePaletteItemViewModel.cs" company="RHEA System S.A.">
...
namespace CDP4DiagramEditor.ViewModels.Palette
{
    ...
    public class InterfaceCreatePaletteItemViewModel : ConnectorCreatePaletteItemBaseViewModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InterfaceCreatePaletteItemViewModel"/> class.
        /// </summary>
        public InterfaceCreatePaletteItemViewModel()
        {
            this.ConnectorTool = new InterfaceConnectorTool();
        }
        ...
        {
            get { return "ExistLink_16x16.png"; }
        }
