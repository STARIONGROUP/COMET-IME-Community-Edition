// --------------------------------------------------------------------------------------------------------------------
// <copyright file="NotAImpliesBImplicationCreatePaletteItemViewModel.cs" company="RHEA System S.A.">
...
namespace CDP4DiagramEditor.ViewModels.Palette
{
    ...
    /// <summary>
    /// Diagram palette button responsible for creating new not A implies B implication
    /// </summary>
    [Export(typeof(IPaletteItemViewModel))]
    public class NotAImpliesBImplicationCreatePaletteItemViewModel : ImplicationCreatePaletteItemViewModel<NotAImpliesBConnectorTool>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotAImpliesBImplicationCreatePaletteItemViewModel" /> class.
        /// </summary>
        public NotAImpliesBImplicationCreatePaletteItemViewModel() : base(ImplicationKind.NotAImpliesB)
        {
        }
        ...
        {
            get { return "not_a_implies_b_16x16.png"; }
        }
    }
}
