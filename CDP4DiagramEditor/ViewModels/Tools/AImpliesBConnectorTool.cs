// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AImpliesBConnectorTool.cs" company="RHEA System S.A.">
...
namespace CDP4DiagramEditor.ViewModels.Tools
{
    ...
    /// <summary>
    /// Implication tool to create A implies B implication
    /// </summary>
    public class AImpliesBConnectorTool : ImplicationConnectorTool
    {
        /// <summary>
        ...
        {
            await base.ExecuteCreate(connector, behavior, ImplicationKind.AImpliesB);
        }
    }
}
