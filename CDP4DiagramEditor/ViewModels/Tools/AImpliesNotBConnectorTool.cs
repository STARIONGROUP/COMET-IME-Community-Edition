// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AImpliesNotBConnectorTool.cs" company="RHEA System S.A.">
...
namespace CDP4DiagramEditor.ViewModels.Tools
{
    ...
    /// <summary>
    /// Implication tool to create A implies not B implication
    /// </summary>
    public class AImpliesNotBConnectorTool : ImplicationConnectorTool
    {
        /// <summary>
        ...
        {
            await base.ExecuteCreate(connector, behavior, ImplicationKind.AImpliesNotB);
        }
    }
}
