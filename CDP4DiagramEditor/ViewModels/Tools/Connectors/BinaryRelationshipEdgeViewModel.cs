// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BinaryRelationshipEdgeViewModel.cs" company="RHEA System S.A.">
...
namespace CDP4DiagramEditor.ViewModels
{
    ...
    /// <summary>
    /// View model for a BinaryRelationship diagram edge
    /// </summary>
    public class BinaryRelationshipEdgeViewModel : DrawnDiagramEdgeViewModel, IPersistedConnector
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BinaryRelationshipEdgeViewModel" /> class
        /// </summary>
