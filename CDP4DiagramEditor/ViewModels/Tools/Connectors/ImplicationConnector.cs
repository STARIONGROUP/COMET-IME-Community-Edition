// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ImplicationConnector.cs" company="RHEA System S.A.">
...
namespace CDP4DiagramEditor.ViewModels
{
    ...
    /// <summary>
    /// The connector representing <see cref="BinaryRelationship"/> that is a implication
    /// </summary>
    public class ImplicationConnector : DrawnConnector
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImplicationConnector" /> class
        /// </summary>
        /// <param name="tool">The associated <see cref="IConnectorTool" /></param>
        public ImplicationConnector(IConnectorTool tool) : base(tool)
        {
