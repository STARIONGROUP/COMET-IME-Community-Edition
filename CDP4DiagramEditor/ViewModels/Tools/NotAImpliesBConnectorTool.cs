// --------------------------------------------------------------------------------------------------------------------
// <copyright file="NotAImpliesBConnectorTool.cs" company="RHEA System S.A.">
...
namespace CDP4DiagramEditor.ViewModels.Tools
{
    ...
    /// <summary>
    /// Implication tool to create not A implies B implication
    /// </summary>
    public class NotAImpliesBConnectorTool : ImplicationConnectorTool
    {
        /// <summary>
        ...
        {
            await base.ExecuteCreate(connector, behavior, ImplicationKind.NotAImpliesB);
        }
    }
}
