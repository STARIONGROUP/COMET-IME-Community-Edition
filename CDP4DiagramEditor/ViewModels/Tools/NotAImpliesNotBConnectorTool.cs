// --------------------------------------------------------------------------------------------------------------------
// <copyright file="NotAImpliesNotBConnectorTool.cs" company="RHEA System S.A.">
...
namespace CDP4DiagramEditor.ViewModels.Tools
{
    ...
    /// <summary>
    /// Implication tool to create not A implies not B implication
    /// </summary>
    public class NotAImpliesNotBConnectorTool : ImplicationConnectorTool
    {
        /// <summary>
        ...
        {
            await base.ExecuteCreate(connector, behavior, ImplicationKind.NotAImpliesNotB);
        }
    }
}
