// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LogInfoControlsViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4LogInfo.ViewModels
{
    ...
    public class LogInfoControlsViewModel : ReactiveObject
    {
        ...
        /// </param>
        public LogInfoControlsViewModel(IDialogNavigationService dialogNavigationService, ICDPMessageBus messageBus)
        {
