...
namespace CDP4ObjectBrowser
{
    ...
    /// </summary>
    public partial class ActualFiniteStateListRowViewModel : ObjectBrowserRowViewModel<ActualFiniteStateList>
    {
        /// <summary>
        /// Intermediate folder containing <see cref="ActualStateRowViewModel"/>
        /// </summary>
        private CDP4Composition.FolderRowViewModel actualStateFolder;
        ...
        {
            this.ComputeRows(this.Thing.ActualState, this.actualStateFolder, this.AddActualStateRowViewModel);
        }
        /// <summary>
        /// Add an Actual State row view model to the list of <see cref="ActualState"/>
        /// </summary>
        /// <param name="actualState">
        /// The <see cref="ActualState"/> that is to be added
        /// </param>
        private ActualFiniteStateRowViewModel AddActualStateRowViewModel(ActualFiniteState actualState)
        {
            return new ActualFiniteStateRowViewModel(actualState, this.Session, this);
        }
    }
}
