...
namespace CDP4ObjectBrowser
{
    ...
    /// </summary>
    public abstract partial class ContractDeviationRowViewModel<T> : ModellingAnnotationItemRowViewModel<T>, IContractDeviationRowViewModel<T> where T :ContractDeviation
    {
        /// <summary>
