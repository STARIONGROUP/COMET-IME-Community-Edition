...
namespace CDP4ObjectBrowser
{
    ...
    /// </summary>
    public abstract partial class ConversionBasedUnitRowViewModel<T> : MeasurementUnitRowViewModel<T>, IConversionBasedUnitRowViewModel<T> where T :ConversionBasedUnit
    {
        /// <summary>
