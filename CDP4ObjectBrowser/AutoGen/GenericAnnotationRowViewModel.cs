// -------------------------------------------------------------------------------------------------
// <copyright file="GenericAnnotationRowViewModel.cs" company="RHEA System S.A.">
...
namespace CDP4ObjectBrowser
{
    ...
    /// </summary>
    public abstract partial class GenericAnnotationRowViewModel<T> : ObjectBrowserRowViewModel<T>, IGenericAnnotationRowViewModel<T> where T :GenericAnnotation
    {
        /// <summary>
