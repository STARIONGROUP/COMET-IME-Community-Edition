...
namespace CDP4ObjectBrowser
{
    ...
    /// <summary>
    /// Row class representing a <see cref="RequirementsSpecification"/>
    /// </summary>
    public partial class RequirementsSpecificationRowViewModel : RequirementsContainerRowViewModel<RequirementsSpecification>
    {
        /// <summary>
        /// Intermediate folder containing <see cref="RequirementRowViewModel"/>
        /// </summary>
        private CDP4Composition.FolderRowViewModel requirementFolder;
        ...
        {
            this.ComputeRows(this.Thing.Requirement, this.requirementFolder, this.AddRequirementRowViewModel);
        }
        /// <summary>
        /// Add an Requirement row view model to the list of <see cref="Requirement"/>
        /// </summary>
        /// <param name="requirement">
        /// The <see cref="Requirement"/> that is to be added
        /// </param>
        private RequirementRowViewModel AddRequirementRowViewModel(Requirement requirement)
        {
            return new RequirementRowViewModel(requirement, this.Session, this);
        }
    }
}
