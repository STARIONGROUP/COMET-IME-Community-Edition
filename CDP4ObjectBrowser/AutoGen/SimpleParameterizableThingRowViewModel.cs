// -------------------------------------------------------------------------------------------------
// <copyright file="SimpleParameterizableThingRowViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4ObjectBrowser
{
    ...
    /// <summary>
    /// Row class representing a <see cref="SimpleParameterizableThing"/>
    /// </summary>
    public abstract partial class SimpleParameterizableThingRowViewModel<T> : DefinedThingRowViewModel<T>, ISimpleParameterizableThingRowViewModel<T> where T :SimpleParameterizableThing
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleParameterizableThingRowViewModel{T}"/> class
        /// </summary>
        /// <param name="simpleParameterizableThing">The <see cref="SimpleParameterizableThing"/> associated with this row</param>
        /// <param name="session">The session</param>
        /// <param name="containerViewModel">The <see cref="IViewModelBase"/> that is the container of this <see cref="IRowViewModelBase"/></param>
        protected SimpleParameterizableThingRowViewModel(T simpleParameterizableThing, ISession session, IViewModelBase<Thing> containerViewModel) : base(simpleParameterizableThing, session, containerViewModel)
        {
