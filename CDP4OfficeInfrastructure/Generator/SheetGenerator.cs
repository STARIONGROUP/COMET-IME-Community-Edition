// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SheetGenerator.cs" company="Starion Group S.A.">
...
namespace CDP4OfficeInfrastructure.Generator
{
    ...
    public abstract class SheetGenerator
    {
        ...
        public void Rebuild(Application application, Workbook workbook)
        {
            ...
            {
                logger.Error(ex);
                this.excelApplication.StatusBar = string.Format("CDP4-COMET: The following error occured while rebuilding the Option sheets: {0}", ex.Message);
            }
            finally
            {
