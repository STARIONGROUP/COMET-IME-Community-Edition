// --------------------------------------------------------------------------------------------------------------------
// <copyright file="StateToParameterTypeMapperBrowserViewModelTestFixture.cs" company="Starion Group S.A.">
...
namespace CDP4ReferenceDataMapper.Tests.ViewModels.StateToParameterTypeMapper
{
    ...
    public class StateToParameterTypeMapperBrowserViewModelTestFixture
    {
        ...
        public async Task Verify_that_SelectedScalarMappingParameterChangedCommand_works()
        {
            ...
            await this.stateToParameterTypeMapperBrowserViewModel.SelectedMappingParameterChangedCommand.Execute(tuple);
