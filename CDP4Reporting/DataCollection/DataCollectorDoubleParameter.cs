...
namespace CDP4Reporting.DataCollection
{
        ...
        where TRow : DataCollectorRow, new()
    {
        ...
        public override double Parse(string value)
        {
            ...
            if (value != null && this.ParameterBase != null)
            {
                calculatedValue = CDP4Common.Helpers.ValueSetConverter.ToValueSetString(calculatedValue, this.ParameterBase.ParameterType);
            }
