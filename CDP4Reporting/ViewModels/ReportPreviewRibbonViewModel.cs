...
namespace CDP4Reporting.ViewModels
{
    ...
    /// <summary>
    /// The view-model for the <see cref="ReportPreviewRibbon"/> view
    /// </summary>
    public class ReportPreviewRibbonViewModel : RibbonButtonIterationDependentViewModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportPreviewRibbonViewModel"/> class.
        /// </summary>
        public ReportPreviewRibbonViewModel()
            : base(InstantiatePanelViewModel)
        {
        }

        /// <summary>
        /// Returns an instance of <see cref="ReportPreviewRibbonViewModel"/>
        /// </summary>
        ...
        /// </param>
        /// <returns>An instance of <see cref="ReportPreviewRibbonViewModel"/></returns>
        public static ReportPreviewViewModel InstantiatePanelViewModel(
            Iteration iteration, 
            ISession session,
            ...
            IPluginSettingsService pluginSettingsService)
        {
            ...
            return new ReportPreviewViewModel(iteration, session, thingDialogNavigationService, panelNavigationService, dialogNavigationService, pluginSettingsService);
        }
    }
}
