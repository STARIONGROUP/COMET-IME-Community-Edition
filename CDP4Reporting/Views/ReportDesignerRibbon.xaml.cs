// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ReportDesignerRibbon.xaml.cs" company="Starion Group S.A.">
...
namespace CDP4Reporting.Views
{
    ...
    public partial class ReportDesignerRibbon : ExtendedRibbonPageGroup, IView
    {
        ...
        public ReportDesignerRibbon(ICDPMessageBus messageBus)
        {
            this.InitializeComponent();
            this.DataContext = new ReportDesignerRibbonViewModel(messageBus);
        }
    }
}
