// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PersonBrowserRibbonViewModelTestFixture.cs" company="Starion Group S.A.">
...
namespace CDP4SiteDirectory.Tests
{
    ...
    /// <summary>
    /// Suite of tests for the <see cref="PersonBrowserRibbonViewModel"/>
    /// </summary>
    [TestFixture]
    public class PersonBrowserRibbonViewModelTestFixture
    {
        private Uri uri;
