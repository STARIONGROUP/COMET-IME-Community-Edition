// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DomainOfExpertiseRibbonViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4SiteDirectory.ViewModels
{
    ...
    public class DomainOfExpertiseRibbonViewModel : RibbonButtonSessionDependentViewModel
    {
        ...
        /// </param>
        public DomainOfExpertiseRibbonViewModel(ICDPMessageBus messageBus)
        ...
        public static IPanelViewModel InstantiatePanelViewModel(ISession session, IThingDialogNavigationService thingDialogNavigationService, IPanelNavigationService panelNavigationService, IDialogNavigationService dialogNavigationService, IPluginSettingsService pluginSettingsService)
        {
            ...
            var viewModel = new DomainOfExpertiseBrowserViewModel(session, session.RetrieveSiteDirectory(), thingDialogNavigationService, panelNavigationService, dialogNavigationService, pluginSettingsService);
            stopWatch.Stop();
            Logger.Info("The Domain of Expertise Browser opened in {0}", stopWatch.Elapsed.ToString("hh':'mm':'ss'.'fff"));
