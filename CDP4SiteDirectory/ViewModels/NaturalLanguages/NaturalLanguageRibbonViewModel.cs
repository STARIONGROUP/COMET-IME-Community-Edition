...
namespace CDP4SiteDirectory.ViewModels
{
    ...
    public class NaturalLanguageRibbonViewModel : RibbonButtonSessionDependentViewModel
    {
        ...
        {
            return new NaturalLanguageBrowserViewModel(session, session.RetrieveSiteDirectory(), thingDialogNavigationService, panelNavigationService, dialogNavigationService);
        }
    }
}