// --------------------------------------------------------------------------------------------------------------------
// <copyright file="NaturalLanguageRibbonViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4SiteDirectory.ViewModels
{
    ...
    public class NaturalLanguageRibbonViewModel : RibbonButtonSessionDependentViewModel
    {
        ...
        /// </summary>
        public NaturalLanguageRibbonViewModel(ICDPMessageBus messageBus)
        ...
        public static IPanelViewModel InstantiatePanelViewModel(ISession session, IThingDialogNavigationService thingDialogNavigationService, IPanelNavigationService panelNavigationService, IDialogNavigationService dialogNavigationService, IPluginSettingsService pluginSettingsService)
        {
            ...
            var viewModel = new NaturalLanguageBrowserViewModel(session, session.RetrieveSiteDirectory(), thingDialogNavigationService, panelNavigationService, dialogNavigationService, pluginSettingsService);
            stopWatch.Stop();
            Logger.Info("The Natural Language Browser opened in {0}", stopWatch.Elapsed.ToString("hh':'mm':'ss'.'fff"));
