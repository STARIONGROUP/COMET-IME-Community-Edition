...
namespace CDP4SiteDirectory.ViewModels
{
    ...
    public class OrganizationBrowserRibbonViewModel : RibbonButtonSessionDependentViewModel
    {
        ...
        {
            return new OrganizationBrowserViewModel(session, session.RetrieveSiteDirectory(), thingDialogNavigationService, panelNavigationService, dialogNavigationService);
        }
    }
}