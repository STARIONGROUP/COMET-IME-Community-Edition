// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TeamCompositionBrowserRibbonViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4SiteDirectory.ViewModels
{
    ...
    public class TeamCompositionBrowserRibbonViewModel : RibbonButtonEngineeringModelSetupDependentViewModel
    {
        ...
        /// </param>
        public TeamCompositionBrowserRibbonViewModel(ICDPMessageBus messageBus)
        ...
        public static IPanelViewModel InstantiatePanelViewModel(EngineeringModelSetup engineeringModelSetup, ISession session, IThingDialogNavigationService thingDialogNavigationService, IPanelNavigationService panelNavigationService, IDialogNavigationService dialogNavigationService, IPluginSettingsService pluginSettingsService)
        {
            ...
            var viewModel = new TeamCompositionBrowserViewModel(engineeringModelSetup, session, thingDialogNavigationService, panelNavigationService, dialogNavigationService, pluginSettingsService);
            stopWatch.Stop();
            Logger.Info("The Team Composition Browser opened in {0}", stopWatch.Elapsed.ToString("hh':'mm':'ss'.'fff"));
