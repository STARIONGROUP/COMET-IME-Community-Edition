// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModelRibbon.xaml.cs" company="Starion Group S.A.">
...
namespace CDP4SiteDirectory.Views
{
    ...
    public partial class ModelRibbon : IView
    {
        ...
        public ModelRibbon(ICDPMessageBus messageBus)
        {
            this.InitializeComponent();
            this.DataContext = new ModelRibbonViewModel(messageBus);
        }
    }
}
