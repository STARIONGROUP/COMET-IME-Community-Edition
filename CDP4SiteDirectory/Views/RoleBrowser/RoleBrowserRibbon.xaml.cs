// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RoleBrowserRibbon.xaml.cs" company="Starion Group S.A.">
...
namespace CDP4SiteDirectory.Views
{
    ...
    public partial class RoleBrowserRibbon : IView
    {
        ...
        public RoleBrowserRibbon(ICDPMessageBus messageBus)
        {
            this.InitializeComponent();
            this.DataContext = new RoleBrowserRibbonViewModel(messageBus);
        }
    }
}
