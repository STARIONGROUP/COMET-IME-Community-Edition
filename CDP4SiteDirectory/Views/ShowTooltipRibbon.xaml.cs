// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ShowDeprecatedRibbon.xaml.cs" company="Starion Group S.A.">
...
namespace CDP4SiteDirectory.Views
{
    ...
    public partial class ShowTooltipRibbon : IView
    {
        ...
        public ShowTooltipRibbon(ICDPMessageBus messageBus)
        {
            ...
            this.DataContext = new ShowTooltipRibbonViewModel(messageBus);
            messageBus.Listen<ToggleTooltipEvent>().Subscribe(this.ToggleTooltipEventHandler);
