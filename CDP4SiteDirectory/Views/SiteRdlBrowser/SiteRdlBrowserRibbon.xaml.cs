// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SiteRdlBrowserRibbon.xaml.cs" company="Starion Group S.A.">
...
namespace CDP4SiteDirectory.Views
{
    ...
    public partial class SiteRdlBrowserRibbon : IView
    {
        ...
        public SiteRdlBrowserRibbon(ICDPMessageBus messageBus)
        {
            this.InitializeComponent();
            this.DataContext = new SiteRdlBrowserRibbonViewModel(messageBus);
        }
    }
}
