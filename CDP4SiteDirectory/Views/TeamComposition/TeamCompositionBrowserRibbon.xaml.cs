// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TeamCompositionBrowserRibbon.xaml.cs" company="Starion Group S.A.">
...
namespace CDP4SiteDirectory.Views
{
    ...
    public partial class TeamCompositionBrowserRibbon : IView
    {
        ...
        public TeamCompositionBrowserRibbon(ICDPMessageBus messageBus)
        {
            this.InitializeComponent();
            this.DataContext = new TeamCompositionBrowserRibbonViewModel(messageBus);
        }
    }
}
