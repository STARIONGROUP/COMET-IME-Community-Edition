...
namespace CDP4VandV.ViewModels
{
    ...
    public class VandVItemDialogViewModel : DialogViewModelBase, IDataErrorInfo
    {
        ...
        private void LoadCoverage(Iteration iteration, Requirement vandVItem)
        {
            ...
            this.SelectedElementDefinition = element ?? parameter?.Container as ElementDefinition;
        ...
        {
            this.SelectedElementDefinition = parameter?.Container as ElementDefinition;
            this.SelectedParameter = parameter;
        }
        ...
        private void PopulateParameters()
        {
            ...
            if (current != null)
            {
                // a stored coverage link may target a ParameterOverride or a parameter of another element; it must
                // stay visible in the picker or the dialog shows blank while the view-model holds a value
