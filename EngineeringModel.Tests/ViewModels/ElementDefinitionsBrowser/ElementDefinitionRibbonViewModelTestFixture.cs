// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ElementDefinitionRibbonViewModelTestFixture.cs" company="Starion Group S.A.">
...
namespace CDP4EngineeringModel.Tests.ViewModels.ElementDefinitionsBrowser
{
    using System;
    ...
    /// <summary>
    /// Suite of tests for the <see cref="ElementDefinitionRibbonViewModel"/> class
    /// </summary>
    [TestFixture]
    public class ElementDefinitionRibbonViewModelTestFixture
    {
