// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DomainFileStoreBrowserRibbonViewModelTestFixture.cs" company="Starion Group S.A.">
...
namespace CDP4EngineeringModel.Tests.ViewModels.DomainFileStoreBrowser
{
    ...
    /// <summary>
    /// Suite of tests for the <see cref="DomainFileStoreBrowserRibbonViewModel"/> class.
    /// </summary>
    [TestFixture]
    public class DomainFileStoreBrowserRibbonViewModelTestFixture
    {
        ...
        {
            var viewmodel = new DomainFileStoreBrowserRibbonViewModel(this.messageBus);
