// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FiniteStateBrowserRibbonViewModelTestFixture.cs" company="Starion Group S.A.">
...
namespace CDP4EngineeringModel.Tests.ViewModels.FiniteStateBrowser
{
    ...
    /// <summary>
    /// Suite of tests for the <see cref="FiniteStateBrowserRibbonViewModel"/> class
    /// </summary>
    [TestFixture]
    public class FiniteStateBrowserRibbonViewModelTestFixture
    {
        ...
        {
            var viewmodel = new FiniteStateBrowserRibbonViewModel(this.messageBus);
        ...
        {
            var viewmodel = FiniteStateBrowserRibbonViewModel.InstantiatePanelViewModel(
                this.iteration,
                this.session.Object,
            ...
            Assert.IsInstanceOf<FiniteStateBrowserViewModel>(viewmodel);
        }
    }
}
