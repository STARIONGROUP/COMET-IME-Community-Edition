...
namespace CDP4EngineeringModel.Tests.ViewModels.OptionBrowser
{
    ...
    /// <summary>
    /// Suite of tests for the <see cref="OptionBrowserRibbonViewModel"/> class
    /// </summary>
    [TestFixture]
    public class OptionBrowserRibbonViewModelTestFixture
    {
        ...
        {
            var viewmodel = OptionBrowserRibbonViewModel.InstantiatePanelViewModel(
                this.iteration,
                this.session.Object,
