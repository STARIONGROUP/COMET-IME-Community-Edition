// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PublicationBrowserRibbonViewModelTestFixture.cs" company="Starion Group S.A.">
...
namespace CDP4EngineeringModel.Tests.ViewModels.PublicationBrowser
{
    ...
    public class PublicationBrowserRibbonViewModelTestFixture
    {
        ...
        {
            var viewmodel = new PublicationBrowserRibbonViewModel(this.messageBus);
