// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IParameterSubscriptionBatchService.cs" company="Starion Group S.A.">
...
namespace CDP4EngineeringModel.Services
{
    ...
    /// <summary>
    /// The purpose of the <see cref="IParameterSubscriptionBatchService"/> is to create/delete multiple <see cref="ParameterSubscription"/>s
    ...
    public interface IParameterSubscriptionBatchService
    {
        ...
        /// Confirmation call back delegate to specify a confirmation action before deletes
        /// </param>  
        /// <returns>
        /// an awaitable <see cref="Task"/>
        /// </returns>
        Task Delete(ISession session, Iteration iteration, bool isUncategorizedIncluded, IEnumerable<Category> categories, IEnumerable<DomainOfExpertise> domainOfExpertises, IEnumerable<ParameterType> parameterTypes, Func<IEnumerable<Parameter>, bool> confirmationCallBack);
    }
}
