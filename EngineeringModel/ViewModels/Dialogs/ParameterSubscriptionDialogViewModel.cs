...
namespace CDP4EngineeringModel.ViewModels
{
    ...
    public class ParameterSubscriptionDialogViewModel : CDP4CommonView.ParameterSubscriptionDialogViewModel, IThingDialogViewModel
    {
        ...
        /// </summary>
        public ReactiveCommand<Unit, Unit> InspectSubcribedParameterCommand { get; protected set; }
        ...
        protected override void InitializeCommands()
        {
            ...
            this.InspectSubcribedParameterCommand = ReactiveCommandCreator.Create(() => this.ExecuteInspectCommand(this.Container), canExecuteInspectSelectedParameterCommand);
        }
