        ...
        protected override void InitializeSubscriptions()
        {
            ...
            else
            {
                ...
                this.Disposables.Add(
                    this.MessageBusHandler.GetHandler<ObjectChangedEvent>().RegisterEventHandler(parameterTypeObserver, new ObjectChangedMessageBusHandlerData(this.Thing.ParameterType, discriminator, action)));
            }
            ...
            else
            {
                ...
                foreach (var state in this.Thing.StateDependence.ActualState)
                {
                    this.actualFiniteStateListener.Add(
                        this.MessageBusHandler.GetHandler<ObjectChangedEvent>().RegisterEventHandler(stateObserver, new ObjectChangedMessageBusHandlerData(state, discriminator, action)));
                }
            }
