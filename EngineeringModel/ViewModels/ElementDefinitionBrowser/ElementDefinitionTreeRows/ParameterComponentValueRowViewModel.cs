            ...
            : base(parameterBase, session, actualOption, actualState, containerRow, valueIndex, isReadOnly)
        {
            ...
            else
            {
                ...
                this.Disposables.Add( 
                    this.MessageBusHandler.GetHandler<ObjectChangedEvent>().RegisterEventHandler(parameterTypComponentObserver, new ObjectChangedMessageBusHandlerData(component, discriminator, action)));
            }
