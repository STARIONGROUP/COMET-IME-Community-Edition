            ...
            : base(parameterBase, session, option, null, containerViewModel, 0, isReadOnly)
        {
            ...
            else
            {
                ...
                this.Disposables.Add(
                    this.MessageBusHandler.GetHandler<ObjectChangedEvent>().RegisterEventHandler(optionObserver, new ObjectChangedMessageBusHandlerData(this.Option, discriminator, action)));
