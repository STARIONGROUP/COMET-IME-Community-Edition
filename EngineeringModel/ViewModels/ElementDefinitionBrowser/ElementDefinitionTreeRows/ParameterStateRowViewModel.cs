            ...
            else
            {
                ...
                foreach (var possibleFiniteState in this.ActualState.PossibleState)
                {
                    this.Disposables.Add( 
                        this.MessageBusHandler.GetHandler<ObjectChangedEvent>().RegisterEventHandler(possibleFiniteStateObserver, new ObjectChangedMessageBusHandlerData(possibleFiniteState, discriminator, action)));
                }
            }
        }
