// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DomainFileStoreBrowserRibbonViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4EngineeringModel.ViewModels
{
    ...
    public class DomainFileStoreBrowserRibbonViewModel : RibbonButtonIterationDependentViewModel
    {
        ...
        /// </param>
        public DomainFileStoreBrowserRibbonViewModel(ICDPMessageBus messageBus) : base(InstantiatePanelViewModel, messageBus)
        {
        }
