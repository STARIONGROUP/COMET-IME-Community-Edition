// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OptionBrowserRibbonViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4EngineeringModel.ViewModels
{
    ...
    public class OptionBrowserRibbonViewModel : RibbonButtonIterationDependentViewModel
    {
        ...
        /// </summary>
        public OptionBrowserRibbonViewModel(ICDPMessageBus messsBus) : base(InstantiatePanelViewModel, messsBus)
        {
        }
