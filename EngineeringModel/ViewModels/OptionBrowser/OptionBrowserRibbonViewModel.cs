...
namespace CDP4EngineeringModel.ViewModels
{
    ...
    public class OptionBrowserRibbonViewModel : RibbonButtonIterationDependentViewModel
    {
        ...
        public static OptionBrowserViewModel InstantiatePanelViewModel(Iteration iteration, ISession session, IThingDialogNavigationService thingDialogNavigationService, IPanelNavigationService panelNavigationService, IDialogNavigationService dialogNavigationService)
        {
            return new OptionBrowserViewModel(iteration, session, thingDialogNavigationService, panelNavigationService, dialogNavigationService);
        }
    }
}