// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OptionBrowserViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4EngineeringModel.ViewModels
{
    ...
    public class OptionBrowserViewModel : BrowserViewModelBase<Iteration>, IPanelViewModel, IDropTarget
    {
        ...
        /// </summary>
        public ReactiveCommand<Unit, Unit> ToggleDefaultCommand { get; private set; }
        ...
        protected override void InitializeCommands()
        {
            ...
            this.CreateCommand = ReactiveCommandCreator.Create(
                () => this.ExecuteCreateCommand<Option>(this.Thing),
                this.WhenAnyValue(x => x.CanCreateOption));

            this.ToggleDefaultCommand = ReactiveCommandCreator.CreateAsyncTask(
                this.ExecuteToggleDefaultCommand,
                this.WhenAnyValue(x => x.CanToggleDefaultOption));
        }
