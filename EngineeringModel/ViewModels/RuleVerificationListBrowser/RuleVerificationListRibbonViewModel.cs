// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RuleVerificationListRibbonViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4EngineeringModel.ViewModels
{
    ...
    public class RuleVerificationListRibbonViewModel : RibbonButtonIterationDependentViewModel
    {
        ...
        /// </param>
        public RuleVerificationListRibbonViewModel(ICDPMessageBus messageBus) : base(InstantiatePanelViewModel, messageBus)
        {
        }
