// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CommonFileStoreBrowserRibbon.xaml.cs" company="Starion Group S.A.">
...
namespace CDP4EngineeringModel.Views
{
    ...
    public partial class CommonFileStoreBrowserRibbon : ExtendedRibbonPageGroup, IView
    {
        ...
        public CommonFileStoreBrowserRibbon(ICDPMessageBus messageBus)
        {
            this.InitializeComponent();
            this.DataContext = new CommonFileStoreBrowserRibbonViewModel(messageBus);
        }
    }
}
