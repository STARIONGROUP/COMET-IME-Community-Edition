// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RuleVerificationListRibbon.xaml.cs" company="Starion Group S.A.">
...
namespace CDP4EngineeringModel.Views
{
    ...
    public partial class RuleVerificationListRibbon : ExtendedRibbonPageGroup, IView
    {
        ...
        public RuleVerificationListRibbon(ICDPMessageBus messageBus)
        {
            this.InitializeComponent();
            this.DataContext = new RuleVerificationListRibbonViewModel(messageBus);
        }
    }
}
