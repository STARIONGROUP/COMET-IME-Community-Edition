// ------------------------------------------------------------------------------------------------
// <copyright file="ElementDefinitionChildRowComparer.cs" company="Starion Group S.A.">
...
namespace CDP4ProductTree.Comparers
{
    ...
    /// <summary>
    /// The <see cref="IComparer{T}"/> used to sort the child rows of the <see cref="ElementDefinitionRowViewModel"/>
    /// </summary>
    public class ElementDefinitionChildRowComparer : IComparer<IRowViewModelBase<Thing>>
    {
        /// <summary>
        ...
        public int Compare(IRowViewModelBase<Thing> x, IRowViewModelBase<Thing> y)
        {
            ...
            if (xType == typeof(ParameterRowViewModel))
            {
                return -1;
            }
            ...
            if (yType == typeof(ParameterRowViewModel))
            {
                return 1;
            }
