// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ProductTreeRibbon.xaml.cs" company="Starion Group S.A.">
...
namespace CDP4ProductTree.Views
{
    ...
    public partial class ProductTreeRibbon : ExtendedRibbonPageGroup, IView
    {
        ...
        public ProductTreeRibbon(ICDPMessageBus messageBus)
        {
            this.InitializeComponent();
            this.DataContext = new ProductTreeRibbonViewModel(messageBus);
        }
    }
}
