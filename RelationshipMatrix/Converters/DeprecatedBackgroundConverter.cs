...
namespace CDP4RelationshipMatrix.Converters
{
    ...
    /// </summary>
    public class DeprecatedBackgroundConverter : BaseMatrixCellViewModelConverter<Brush>
    {
        /// <summary>
        ...
        protected override Brush ConvertRowObject(IDictionary<string, MatrixCellViewModel> row, string fieldName)
        {
            ...
            return matrixCellViewModel.IsDeprecated ? Brushes.LightGray : Brushes.Transparent;
        }
    }
}
