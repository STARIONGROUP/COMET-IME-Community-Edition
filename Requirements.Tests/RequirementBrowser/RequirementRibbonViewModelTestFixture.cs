// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RequirementRibbonViewModelTestFixture.cs" company="Starion Group S.A.">
...
namespace CDP4Requirements.Tests
{
    ...
    /// <summary>
    /// Suite of tests for the <see cref="RequirementRibbonViewModel"/> class.
    /// </summary>
    [TestFixture]
    public class RequirementRibbonViewModelTestFixture
    {
        ...
        {
            Assert.DoesNotThrow(() => new RequirementRibbonViewModel(this.messageBus));
        }
