...
namespace CDP4Requirements.ReqIFDal
{
    ...
    public class ReqIFBuilder
    {
        ...
        {
            this.language = lang;
            this.mapper = new ThingToReqIfMapper();
        ...
        #region ReqIf Element Instantiation
        /// <summary>
        ...
        private void InstantiateDataTypeDefinition()
        {
            ...
            var groups = specs.SelectMany(x => x.GetAllContainedGroups());
        ...
        {
            var requirements = this.exportedIteration.RequirementsSpecification.SelectMany(x => x.Requirement).ToList();
            foreach (var requirement in requirements)
            {
