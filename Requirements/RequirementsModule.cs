// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RequirementsModule.cs" company="Starion Group S.A.">
...
namespace CDP4Requirements
{
    ...
    public class RequirementsModule : IModule
    {
        ...
        /// </summary>
        internal ICDPMessageBus CDPMessageBus { get; }
        ...
        {
            var requirementRibbonPart = new RequirementRibbonPart(2000, this.PanelNavigationService, this.DialogNavigationService, this.ThingDialogNavigationService, this.PluginSettingsService, this.OfficeApplicationWrapper, this.CDPMessageBus);
