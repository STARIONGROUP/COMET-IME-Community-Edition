// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SpecificationTypeMapConverter.cs" company="RHEA System S.A.">
...
namespace CDP4Requirements.Settings.JsonConverters
{
    ...
    /// </summary>
    public class SpecificationTypeMapConverter : JsonConverter<Dictionary<SpecificationType, SpecTypeMap>>
    {
        /// <summary>
