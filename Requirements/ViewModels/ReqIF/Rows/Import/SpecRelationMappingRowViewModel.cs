// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SpecRelationMappingRowViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4Requirements.ViewModels
{
    ...
    /// <summary>
    /// The row-view-model for the <see cref="SpecRelation"/> mapping
    /// </summary>
    public class SpecRelationMappingRowViewModel : SpecTypeRowViewModel<SpecRelationType>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SpecRelationMappingRowViewModel"/> class
        /// </summary>
        /// <param name="specRelationType">The <see cref="SpecRelationType"/></param>
        /// <param name="iteration"></param>
        /// <param name="parameterTypeMap"></param>
        /// <param name="refreshCanGoNext"></param>
        public SpecRelationMappingRowViewModel(SpecRelationType specRelationType, Iteration iteration, IReadOnlyDictionary<DatatypeDefinition, DatatypeDefinitionMap> parameterTypeMap, Action refreshCanGoNext)
