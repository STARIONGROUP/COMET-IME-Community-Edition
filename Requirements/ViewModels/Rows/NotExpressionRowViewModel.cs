// --------------------------------------------------------------------------------------------------------------------
// <copyright file="NotExpressionRowViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4Requirements.ViewModels
{
    ...
    /// </summary>
    public class NotExpressionRowViewModel : CDP4CommonView.NotExpressionRowViewModel, IDeprecatableThing, IHaveWritableRequirementStateOfCompliance
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the string representation of the current <see cref="NotExpression"/>
        /// </summary>
