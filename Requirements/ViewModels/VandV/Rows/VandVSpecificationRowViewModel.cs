// --------------------------------------------------------------------------------------------------------------------
// <copyright file="VandVSpecificationRowViewModel.cs" company="Starion Group S.A.">
...
namespace CDP4Requirements.ViewModels.Rows
{
    ...
    /// <summary>
    /// A root row in the VCD browser representing a <see cref="RequirementsSpecification"/>, mirroring the grouping of
    /// the stock Requirements browser so the V&amp;V register reads the same way as the specification it covers.
    /// </summary>
    public class VandVSpecificationRowViewModel : RowViewModelBase<RequirementsSpecification>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VandVSpecificationRowViewModel"/> class.
        /// </summary>
        ...
        public VandVSpecificationRowViewModel(RequirementsSpecification specification, ISession session, IViewModelBase<Thing> containerViewModel)
            : base(specification, session, containerViewModel)
        {
            this.SetProperties();
        }
        ...
        /// <summary>Gets the specification short-name.</summary>
        ...
        /// <summary>
        /// Refreshes the projected properties when the underlying <see cref="RequirementsSpecification"/> changes.
        /// </summary>
        ...
        /// <summary>
        /// Updates the projected properties from the underlying <see cref="RequirementsSpecification"/>.
        /// </summary>
