// ------------------------------------------------------------------------------------------------
// <copyright file="AttributeDefMapCellTemplateSelector.cs" company="Starion Group S.A.">
...
namespace CDP4Requirements.Views
{
    ...
    /// </summary>
    public class AttributeDefMapCellTemplateSelector : DataTemplateSelector
    {
        /// <summary>
        ...
        public override DataTemplate SelectTemplate(object item, DependencyObject container)
        {
            ...
            if (rowObject != null)
            {
                return this.AttributeDefMapCellTemplate;
            }
        ...
        /// </summary>
        public DataTemplate AttributeDefMapCellTemplate { get; set; }
